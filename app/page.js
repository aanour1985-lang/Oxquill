...
export default function Home() {
  ...
  async function handleCreateAnnouncement() {
    ...
    try {
      ...
      setAnnounceForm({ title: "", message: "", type: "notification", target_plan: "all", target_language: "all", expires_at: "" });
      ...
      {visibleModal && (
        <div style={{
          ...
          <div style={{
            ...
            }}>{visibleModal.title}</h2>
            <p style={{
              fontSize: "0.9rem", color: TH.text,
              lineHeight: 1.6, marginBottom: "20px",
              whiteSpace: "pre-wrap", textAlign: "center",
            }}>{visibleModal.message}</p>
            <button
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ flex: 1, minWidth: 0, paddingInlineEnd: "20px" }}>
                ...
                }}>{visibleBanner.title}</h4>
                <p style={{
                  fontSize: "0.82rem", color: TH.textSec,
                  lineHeight: 1.5, margin: 0,
                  whiteSpace: "pre-wrap",
                }}>{visibleBanner.message}</p>
              </div>
              <button
            ...
            {adminTab === "announcements" && (
              <div>
                ...
                <div style={Object.assign({}, cardStyle, { marginBottom: "18px" })}>
                  ...
                  <label style={{ fontSize: "0.75rem", color: TH.textSec, display: "block", marginBottom: "4px" }}>
                    {rtl ? "\u0627\u0644\u0639\u0646\u0648\u0627\u0646" : "Title"}
                  </label>
                  <input
                    value={announceForm.title}
                    onChange={function (e) { setAnnounceForm(Object.assign({}, announceForm, { title: e.target.value })); }}
                    placeholder={rtl ? "\u0645\u062b\u0627\u0644: \u062a\u062d\u062f\u064a\u062b \u062c\u062f\u064a\u062f" : "e.g. New Update"}
                    style={Object.assign({}, inputStyle, { marginBottom: "10px" })}
                  />
                  ...
                  <textarea
                    ...
                    placeholder={rtl ? "\u0627\u0643\u062a\u0628 \u0646\u0635 \u0627\u0644\u0625\u0639\u0644\u0627\u0646..." : "Write announcement text..."}
                    rows={3}
                    style={Object.assign({}, inputStyle, { marginBottom: "10px", fontFamily: "inherit", resize: "vertical" })}
                  />
                  ...
                  return (
                    <div key={a.id} style={Object.assign({}, cardStyle, {
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "10px", marginBottom: "6px" }}>
                        <h5 style={{ fontWeight: 700, fontSize: "0.95rem", margin: 0, flex: 1 }}>{a.title}</h5>
                        <span style={{ fontSize: "0.68rem", color: TH.textSec, whiteSpace: "nowrap" }}>
                          {typeIcon + " " + typeLabel}
                        </span>
                      </div>
                      <p style={{ fontSize: "0.83rem", color: TH.text, marginBottom: "8px", whiteSpace: "pre-wrap" }}>
                        {a.message}
                      </p>
