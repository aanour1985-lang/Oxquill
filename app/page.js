...
var I18N = {
  ...
  heroSub: { en: ".", ar: "." },
  heroDesc: { en: "From first draft to published masterpiece \u2014 in minutes, not months. 29 languages. 31 eras. Your voice, amplified.", ar: "\u0645\u0646 \u0627\u0644\u0645\u0633\u0648\u062f\u0629 \u0627\u0644\u0623\u0648\u0644\u0649 \u0625\u0644\u0649 \u0627\u0644\u062a\u062d\u0641\u0629 \u0627\u0644\u0645\u0646\u0634\u0648\u0631\u0629 \u2014 \u0641\u064a \u062f\u0642\u0627\u0626\u0642\u060c \u0645\u0634 \u0634\u0647\u0648\u0631. 29 \u0644\u063a\u0629. 31 \u062d\u0642\u0628\u0629. \u0635\u0648\u062a\u0643\u060c \u0628\u0623\u0636\u0639\u0627\u0641 \u0642\u0648\u062a\u0647." },
...
/* ============ DATA ============ */
/* V3.0 — Brand SVG icons for platforms that don't have official emojis */
function XLogo(props) {
  var size = (props && props.size) || 14;
  var color = (props && props.color) || "currentColor";
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color} style={{ verticalAlign: "middle", display: "inline-block" }} aria-hidden="true">
...
function LinkedInLogo(props) {
  var size = (props && props.size) || 14;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#0A66C2" style={{ verticalAlign: "middle", display: "inline-block" }} aria-hidden="true">
...
var TOOLS = [
  { id: "generate", icon: "\u270d\ufe0f", cost: 5, en: "Generate", ar: "\u062a\u0648\u0644\u064a\u062f",
    descEn: "Write a full article from scratch. Provide a topic, choose language and mood, and AI will write it for you.",
    descAr: "\u0627\u0643\u062a\u0628 \u0645\u0642\u0627\u0644 \u0643\u0627\u0645\u0644 \u0645\u0646 \u0627\u0644\u0635\u0641\u0631. \u062d\u062f\u062f \u0627\u0644\u0645\u0648\u0636\u0648\u0639 \u0648\u0627\u062e\u062a\u0627\u0631 \u0627\u0644\u0644\u063a\u0629 \u0648\u0627\u0644\u0646\u0628\u0631\u0629 \u0648\u0627\u0644\u0630\u0643\u0627\u0621 \u0627\u0644\u0627\u0635\u0637\u0646\u0627\u0639\u064a \u0647\u064a\u0643\u062a\u0628\u0647 \u0644\u0643." },
  { id: "viral", icon: "\ud83d\udcca", cost: 2, en: "Viral Score", ar: "\u0645\u062a\u0646\u0628\u0626 \u0627\u0646\u062a\u0634\u0627\u0631",
    descEn: "Paste any content and get a viral potential score (1-100) with feedback on what works and what doesn't.",
    descAr: "\u0627\u0644\u0635\u0642 \u0623\u064a \u0645\u062d\u062a\u0648\u0649 \u0648\u0627\u062d\u0635\u0644 \u0639\u0644\u0649 \u062a\u0642\u064a\u064a\u0645 \u0644\u0642\u0648\u0629 \u0627\u0646\u062a\u0634\u0627\u0631\u0647 (1-100) \u0645\u0639 \u062a\u062d\u0644\u064a\u0644 \u0644\u0644\u0646\u0642\u0627\u0637 \u0627\u0644\u0642\u0648\u064a\u0629 \u0648\u0627\u0644\u0636\u0639\u064a\u0641\u0629." },
  { id: "remix", icon: "\ud83d\udd04", cost: 3, en: "Remix", ar: "\u0631\u064a\u0645\u0643\u0633",
    descEn: "Rewrite existing content in a different style or tone. Keep the meaning, change the vibe.",
    descAr: "\u0623\u0639\u062f \u0635\u064a\u0627\u063a\u0629 \u0645\u062d\u062a\u0648\u0649 \u0645\u0648\u062c\u0648\u062f \u0628\u0623\u0633\u0644\u0648\u0628 \u0623\u0648 \u0646\u0628\u0631\u0629 \u0645\u062e\u062a\u0644\u0641\u0629. \u0627\u0644\u0645\u0639\u0646\u0649 \u064a\u0628\u0642\u0649\u060c \u0627\u0644\u0625\u062d\u0633\u0627\u0633 \u064a\u062a\u063a\u064a\u0631." },
  { id: "summary", icon: "\ud83d\udcdd", cost: 1, en: "Summary", ar: "\u0645\u0644\u062e\u0635",
    descEn: "Get a quick summary of any long content in 3 bullets plus a TL;DR. Perfect for research or emails.",
    descAr: "\u0627\u062d\u0635\u0644 \u0639\u0644\u0649 \u0645\u0644\u062e\u0635 \u0633\u0631\u064a\u0639 \u0644\u0623\u064a \u0645\u062d\u062a\u0648\u0649 \u0637\u0648\u064a\u0644 \u0641\u064a 3 \u0646\u0642\u0627\u0637 + \u062e\u0644\u0627\u0635\u0629. \u0645\u0641\u064a\u062f \u0644\u0644\u0628\u062d\u062b \u0623\u0648 \u0627\u0644\u0625\u064a\u0645\u064a\u0644\u0627\u062a." },
  { id: "titles", icon: "\ud83d\udca1", cost: 1, en: "Titles", ar: "\u0639\u0646\u0627\u0648\u064a\u0646",
    descEn: "Generate 10 click-worthy SEO titles for your content. Great for blogs, YouTube, and articles.",
    descAr: "\u0648\u0644\u062f 10 \u0639\u0646\u0627\u0648\u064a\u0646 \u062c\u0630\u0627\u0628\u0629 \u0648\u0645\u0647\u064a\u0623\u0629 \u0644\u0645\u062d\u0631\u0643\u0627\u062a \u0627\u0644\u0628\u062d\u062b. \u0645\u0645\u062a\u0627\u0632 \u0644\u0644\u0645\u062f\u0648\u0646\u0627\u062a \u0648\u064a\u0648\u062a\u064a\u0648\u0628 \u0648\u0627\u0644\u0645\u0642\u0627\u0644\u0627\u062a." },
  { id: "thread", icon: "\ud83e\uddf5", svgIcon: "x", cost: 2, en: "Thread", ar: "\u062b\u0631\u064a\u062f",
    descEn: "Convert any content into a Twitter/X thread of 8-12 engaging tweets with hooks and CTAs.",
    descAr: "\u062d\u0648\u0644 \u0623\u064a \u0645\u062d\u062a\u0648\u0649 \u0644\u062b\u0631\u064a\u062f \u0645\u0646 8-12 \u062a\u063a\u0631\u064a\u062f\u0629 \u062c\u0630\u0627\u0628\u0629 \u0639\u0644\u0649 \u062a\u0648\u064a\u062a\u0631/\u0625\u0643\u0633 \u0645\u0639 \u0647\u0648\u0643 \u0648\u062f\u0639\u0648\u0629 \u0644\u0644\u062a\u0641\u0627\u0639\u0644." },
  { id: "linkedin", icon: "\ud83d\udcbc", svgIcon: "linkedin", cost: 2, en: "LinkedIn", ar: "\u0644\u064a\u0646\u0643\u062f\u0625\u0646",
    descEn: "Transform content into a professional LinkedIn post with hooks, hashtags, and strong formatting.",
    descAr: "\u062d\u0648\u0644 \u0645\u062d\u062a\u0648\u0627\u0643 \u0644\u0628\u0648\u0633\u062a \u0644\u064a\u0646\u0643\u062f\u0625\u0646 \u0627\u062d\u062a\u0631\u0627\u0641\u064a \u0645\u0639 \u0647\u0648\u0643 \u0648\u0647\u0627\u0634\u062a\u0627\u062c\u0627\u062a \u0648\u062a\u0646\u0633\u064a\u0642 \u0642\u0648\u064a." },
  { id: "repurpose", icon: "\u267b\ufe0f", cost: 5, en: "Repurpose", ar: "\u0625\u0639\u0627\u062f\u0629 \u062a\u0648\u0638\u064a\u0641",
    descEn: "Turn 1 piece of content into 5 formats: blog post, social post, newsletter, video script, and podcast outline.",
    descAr: "\u062d\u0648\u0644 \u0645\u062d\u062a\u0648\u0649 \u0648\u0627\u062d\u062f \u0644\u0640 5 \u0635\u064a\u063a: \u0645\u062f\u0648\u0646\u0629\u060c \u0628\u0648\u0633\u062a \u0633\u0648\u0634\u064a\u0627\u0644\u060c \u0646\u0634\u0631\u0629 \u0628\u0631\u064a\u062f\u064a\u0629\u060c \u0633\u0643\u0631\u064a\u0628\u062a \u0641\u064a\u062f\u064a\u0648\u060c \u0648\u0645\u062e\u0637\u0637 \u0628\u0648\u062f\u0643\u0627\u0633\u062a." },
];
...
/* V3.5 — Era emoji mapper: expressive emoji per decade/era */
function eraEmoji(yr) {
  var n = parseInt(yr, 10);
  if (isNaN(n)) return "\ud83d\udcdc"; /* 📜 scroll */
  if (n <= 1910) return "\ud83c\udfad"; /* 🎭 victorian/classic */
  if (n <= 1925) return "\ud83c\udfa9"; /* 🎩 1920s gatsby era */
  if (n <= 1935) return "\ud83c\udfac"; /* 🎬 golden age of cinema */
  if (n <= 1945) return "\u2708\ufe0f"; /* ✈️ WWII era */
  if (n <= 1955) return "\ud83d\udd7a"; /* 🕺 50s rock'n'roll */
  if (n <= 1965) return "\u270c\ufe0f"; /* ✌️ 60s peace */
  if (n <= 1975) return "\ud83c\udf3b"; /* 🌻 70s flower power */
  if (n <= 1985) return "\ud83d\udcfc"; /* 📼 80s VHS */
  if (n <= 1995) return "\ud83d\udcbe"; /* 💾 90s floppy */
  if (n <= 2005) return "\ud83d\udcf1"; /* 📱 Y2K early internet */
  if (n <= 2015) return "\ud83d\udcbb"; /* 💻 social media era */
  if (n <= 2024) return "\ud83d\udd25"; /* 🔥 current era */
  if (n <= 2030) return "\ud83e\udd16"; /* 🤖 near future AI */
  return "\ud83d\ude80"; /* 🚀 far future */
}

/* V3.5 — Plan emoji mapper */
var PLAN_EMOJI = {
  "all": "\ud83d\udc65",     /* 👥 all users */
  "free": "\ud83c\udd93",    /* 🆓 free */
  "starter": "\u2b50",        /* ⭐ starter */
...
var FEATURES = [
  { icon: "\u270d\ufe0f", en: "AI Writer", ar: "\u0643\u0627\u062a\u0628 AI", descEn: "8 AI tools, 29 languages, 6 moods", descAr: "8 \u0623\u062f\u0648\u0627\u062a AI\u060c 29 \u0644\u063a\u0629\u060c 6 \u0646\u0628\u0631\u0627\u062a", go: "writer" },
  ...
  { icon: "\ud83c\udf0d", en: "29 Languages", ar: "29 \u0644\u063a\u0629", descEn: "Write in any language", descAr: "\u0627\u0643\u062a\u0628 \u0628\u0623\u064a \u0644\u063a\u0629", go: "writer" },
...
export default function Home() {
  ...
  /* V3.1 — API Usage tracking */
  var [apiStats, setApiStats] = useState({
    balance: 0,
    inputPrice: 3,
    outputPrice: 15,
    threshold: 10,
  ...
  var [apiSettingsEdit, setApiSettingsEdit] = useState({ balance: "", inputPrice: "", outputPrice: "", threshold: "" });
  ...
  var [loadingAnnouncements, setLoadingAnnouncements] = useState(false);
  var [visibleBanner, setVisibleBanner] = useState(null);
  var [visibleModal, setVisibleModal] = useState(null);
  var [announceForm, setAnnounceForm] = useState({
    title: "", title_ar: "", message: "", message_ar: "", type: "notification",
    target_plan: "all", target_language: "all", expires_at: "",
  });
  ...
  async function deleteMessage(msgId) {
    ...
    try {
      var res = await safeSupa.from("contact_messages").delete().eq("id", msgId);
      if (res.error) throw res.error;
      setAdminMessages(function (prev) {
        return prev.filter(function (m) { return m.id !== msgId; });
      });
      showToast(rtl ? "\u062a\u0645 \u0627\u0644\u062d\u0630\u0641" : "Deleted", "success");
    } catch (e) {
  ...
  async function markNotificationRead(notifId) {
    ...
    /* V3.4 — If this is an announcement notification, track in localStorage
       (announcements don't have DB rows in notifications table) */
    if (typeof notifId === "string" && notifId.indexOf("announce_") === 0) {
      var announcementId = notifId.replace("announce_", "");
      try {
        var raw = localStorage.getItem("oxq_seen_announcements");
        var seen = raw ? JSON.parse(raw) : {};
        seen[announcementId] = Date.now();
        localStorage.setItem("oxq_seen_announcements", JSON.stringify(seen));
      } catch (e) {}
  ...
  /* V3.1 — Fetch Claude API usage when Admin Dashboard is opened */
  useEffect(function () {
    if (view !== "admin" || adminTab !== "dashboard" || !safeSupa || !user) return;
    var isAdmin = user.isAdmin || user.email === "aanour1985@gmail.com";
    if (!isAdmin) return;
    ...
    async function fetchApiStats() {
      try {
        /* 1. Settings (balance, prices, threshold) */
        var setRes = await safeSupa
          .from("api_settings")
          .select("*")
          .eq("id", 1)
          .maybeSingle();

        var balance = 0, inputPrice = 3, outputPrice = 15, threshold = 10;
        if (setRes && setRes.data) {
          balance = Number(setRes.data.balance_usd) || 0;
          inputPrice = Number(setRes.data.input_price_per_1m) || 3;
          outputPrice = Number(setRes.data.output_price_per_1m) || 15;
          threshold = Number(setRes.data.low_balance_threshold) || 10;
        }

        /* 2. This month's usage (from 1st of current month) */
        var now = new Date();
        var monthStart = new Date(now.getFullYear(), now.getMonth(), 1).toISOString();
        var usageRes = await safeSupa
          .from("api_usage")
          .select("input_tokens, output_tokens, cost_usd, created_at, user_id")
          .gte("created_at", monthStart);

        var monthTokensInput = 0, monthTokensOutput = 0, monthCost = 0;
        var dailyMap = {}; /* YYYY-MM-DD → { cost, tokens } */
        var userMap = {};  /* user_id → { cost, tokens } */
        if (usageRes && usageRes.data) {
          usageRes.data.forEach(function (row) {
            monthTokensInput += row.input_tokens || 0;
            monthTokensOutput += row.output_tokens || 0;
            monthCost += Number(row.cost_usd) || 0;
            var day = (row.created_at || "").slice(0, 10);
            if (!dailyMap[day]) dailyMap[day] = { cost: 0, tokens: 0 };
            dailyMap[day].cost += Number(row.cost_usd) || 0;
            dailyMap[day].tokens += (row.input_tokens || 0) + (row.output_tokens || 0);
            if (row.user_id) {
              if (!userMap[row.user_id]) userMap[row.user_id] = { cost: 0, tokens: 0 };
              userMap[row.user_id].cost += Number(row.cost_usd) || 0;
              userMap[row.user_id].tokens += (row.input_tokens || 0) + (row.output_tokens || 0);
            }
          });
        }

        /* 3. Build daily series for last 30 days (fill gaps with 0) */
        var dailySeries = [];
        for (var i = 29; i >= 0; i--) {
          var d = new Date(now);
          ...
          dailySeries.push({
            date: key,
            cost: dailyMap[key] ? dailyMap[key].cost : 0,
            tokens: dailyMap[key] ? dailyMap[key].tokens : 0,
          });
        }

        /* 4. Top users: fetch profiles for top 10 user_ids by cost */
        var userIds = Object.keys(userMap)
          .sort(function (a, b) { return userMap[b].cost - userMap[a].cost; })
          .slice(0, 10);
        var topUsers = [];
        if (userIds.length > 0) {
          var profRes = await safeSupa
          ...
          if (profRes && profRes.data) {
            ...
            topUsers = userIds.map(function (uid) {
              var p = profMap[uid] || {};
              return {
                email: p.email || "(deleted user)",
                name: p.name || "",
                cost: userMap[uid].cost,
                tokens: userMap[uid].tokens,
              };
            });
          }
        }
        ...
        setApiStats({
          ...
          threshold: threshold,
          monthTokensInput: monthTokensInput,
          monthTokensOutput: monthTokensOutput,
          monthCost: monthCost,
          dailySeries: dailySeries,
          topUsers: topUsers,
        });
      } catch (e) {
        console.error("fetchApiStats failed:", e);
      } finally {
        setLoadingApi(false);
      }
    }
    ...
    setLoadingApi(true);
    fetchApiStats();
    var apiInterval = setInterval(fetchApiStats, 60000);
    return function () { clearInterval(apiInterval); };
  }, [view, adminTab, user]);

  /* V3.1 — Save API settings (balance, prices, threshold) */
  async function handleSaveApiSettings() {
    if (!safeSupa) return;
    var updates = {};
    if (apiSettingsEdit.balance !== "" && !isNaN(Number(apiSettingsEdit.balance))) {
      updates.balance_usd = Number(apiSettingsEdit.balance);
    }
    if (apiSettingsEdit.inputPrice !== "" && !isNaN(Number(apiSettingsEdit.inputPrice))) {
      updates.input_price_per_1m = Number(apiSettingsEdit.inputPrice);
    }
    if (apiSettingsEdit.outputPrice !== "" && !isNaN(Number(apiSettingsEdit.outputPrice))) {
      updates.output_price_per_1m = Number(apiSettingsEdit.outputPrice);
    }
    if (apiSettingsEdit.threshold !== "" && !isNaN(Number(apiSettingsEdit.threshold))) {
      updates.low_balance_threshold = Number(apiSettingsEdit.threshold);
    }
    if (Object.keys(updates).length === 0) {
      showToast(rtl ? "\u0644\u0627 \u064a\u0648\u062c\u062f \u062a\u063a\u064a\u064a\u0631\u0627\u062a" : "No changes", "error");
      return;
    }
    updates.updated_at = new Date().toISOString();
    try {
      var res = await safeSupa.from("api_settings").update(updates).eq("id", 1);
      if (res.error) throw res.error;
      showToast(rtl ? "\u062a\u0645 \u0627\u0644\u062d\u0641\u0638" : "Saved", "success");
      setApiSettingsEdit({ balance: "", inputPrice: "", outputPrice: "", threshold: "" });
      /* Optimistic update — mirror all saved fields in UI state */
      setApiStats(function (prev) {
        var next = Object.assign({}, prev);
        if (updates.balance_usd != null) next.balance = updates.balance_usd;
        if (updates.input_price_per_1m != null) next.inputPrice = updates.input_price_per_1m;
        if (updates.output_price_per_1m != null) next.outputPrice = updates.output_price_per_1m;
        if (updates.low_balance_threshold != null) next.threshold = updates.low_balance_threshold;
        return next;
      });
    } catch (e) {
      showToast((rtl ? "\u062e\u0637\u0623: " : "Error: ") + (e.message || ""), "error");
  ...
  /* V3.4 — Fetch active announcements for current user (filtered by plan + language) */
  useEffect(function () {
    if (!safeSupa) return;
    async function fetchUserAnnouncements() {
      try {
        ...
        /* Filter by plan + language */
        var userPlan = (user && user.plan) || "free";
        var userLang = rtl ? "ar" : "en";
        var filtered = res.data.filter(function (a) {
          var planOk = a.target_plan === "all" || a.target_plan === userPlan;
          var langOk = a.target_language === "all" || a.target_language === userLang;
          return planOk && langOk;
        });

        /* Find dismissed announcements from localStorage */
        var dismissed = {};
        try {
          var raw = localStorage.getItem("oxq_dismissed_announcements");
          if (raw) dismissed = JSON.parse(raw);
        } catch (e) {}

        /* Pick first active banner (not dismissed) */
        var banner = null, modal = null;
        filtered.forEach(function (a) {
          if (dismissed[a.id]) return;
          if (a.type === "banner" && !banner) banner = a;
          if (a.type === "modal" && !modal) modal = a;
        });

        setVisibleBanner(banner);
        setVisibleModal(modal);

        /* For 'notification' type: show in bell dropdown via local state
           (merged with DB notifications). Track "seen" in localStorage
           to avoid showing the badge for already-seen announcements. */
        var seen = {};
        try {
          var rawSeen = localStorage.getItem("oxq_seen_announcements");
          if (rawSeen) seen = JSON.parse(rawSeen);
        } catch (e) {}

        var announcementNotifs = filtered
          .filter(function (a) { return a.type === "notification"; })
          .map(function (a) {
            return {
              id: "announce_" + a.id,
              type: "announcement",
              title: rtl ? (a.title_ar || a.title) : (a.title || a.title_ar),
              message: rtl ? (a.message_ar || a.message) : (a.message || a.message_ar),
              is_read: !!seen[a.id],
        ...
        if (announcementNotifs.length > 0) {
          setNotifications(function (prev) {
            /* Prepend only those not already in the list */
            var existing = {};
            prev.forEach(function (n) { if (n.id) existing[n.id] = true; });
            var fresh = announcementNotifs.filter(function (n) { return !existing[n.id]; });
            return fresh.concat(prev);
          });
          /* Update unread count with unseen announcements */
          var unseenCount = announcementNotifs.filter(function (n) { return !n.is_read; }).length;
          if (unseenCount > 0) {
            setUnreadCount(function (c) { return c + unseenCount; });
          }
        }
      } catch (e) {
        console.error("fetchUserAnnouncements failed:", e);
      }
    }
    fetchUserAnnouncements();
  }, [user, rtl]);

  /* V3.4 — Dismiss banner/modal (save to localStorage) */
  function dismissAnnouncement(id) {
    try {
      var raw = localStorage.getItem("oxq_dismissed_announcements");
      var dismissed = raw ? JSON.parse(raw) : {};
      dismissed[id] = Date.now();
      localStorage.setItem("oxq_dismissed_announcements", JSON.stringify(dismissed));
    } catch (e) {}
    if (visibleBanner && visibleBanner.id === id) setVisibleBanner(null);
    if (visibleModal && visibleModal.id === id) setVisibleModal(null);
  }

  /* V3.4.1 — Pick localized title/message from bilingual announcement.
     Falls back to the other language if selected language is empty. */
  function annTitle(a) {
    if (!a) return "";
    if (rtl) return a.title_ar || a.title || "";
    return a.title || a.title_ar || "";
  }
  function annMessage(a) {
    if (!a) return "";
    if (rtl) return a.message_ar || a.message || "";
    return a.message || a.message_ar || "";
  }

  /* V3.4 — Admin: Fetch all announcements */
  useEffect(function () {
    if (view !== "admin" || adminTab !== "announcements" || !safeSupa || !user) return;
    var isAdmin = user.isAdmin || user.email === "aanour1985@gmail.com";
    if (!isAdmin) return;
    ...
    async function fetchAdminAnnouncements() {
      try {
        ...
        console.error("fetchAdminAnnouncements failed:", e);
      } finally {
  ...
  /* V3.4 — Admin: Create new announcement */
  async function handleCreateAnnouncement() {
    if (!safeSupa || !user) return;
    var titleEn = announceForm.title.trim();
    var titleAr = announceForm.title_ar.trim();
    var msgEn = announceForm.message.trim();
    var msgAr = announceForm.message_ar.trim();
    /* Require at least one language's content */
    if ((!titleEn && !titleAr) || (!msgEn && !msgAr)) {
      showToast(rtl ? "\u0627\u0644\u0639\u0646\u0648\u0627\u0646 \u0648\u0627\u0644\u0631\u0633\u0627\u0644\u0629 \u0645\u0637\u0644\u0648\u0628\u0627\u0646" : "Title and message required", "error");
      return;
    }
    try {
      var payload = {
        /* If one language is empty, fallback to the other so display never breaks */
        title: titleEn || titleAr,
        title_ar: titleAr || titleEn,
        message: msgEn || msgAr,
        message_ar: msgAr || msgEn,
        type: announceForm.type,
        target_plan: announceForm.target_plan,
        target_language: announceForm.target_language,
        is_active: true,
        created_by: user.id,
      };
      if (announceForm.expires_at) {
        payload.expires_at = new Date(announceForm.expires_at).toISOString();
      }
      var res = await safeSupa.from("announcements").insert([payload]).select().single();
      if (res.error) throw res.error;
      setAnnouncements(function (prev) { return [res.data].concat(prev); });
      setAnnounceForm({ title: "", title_ar: "", message: "", message_ar: "", type: "notification", target_plan: "all", target_language: "all", expires_at: "" });
      showToast(rtl ? "\u062a\u0645 \u0627\u0644\u0646\u0634\u0631" : "Published", "success");
    } catch (e) {
      showToast((rtl ? "\u062e\u0637\u0623: " : "Error: ") + (e.message || ""), "error");
    }
  }

  /* V3.4 — Admin: Delete announcement */
  async function handleDeleteAnnouncement(id) {
    if (!safeSupa) return;
    var confirmMsg = rtl ? "\u0647\u0644 \u0623\u0646\u062a \u0645\u062a\u0623\u0643\u062f \u0645\u0646 \u062d\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0625\u0639\u0644\u0627\u0646\u061f" : "Delete this announcement?";
    if (!window.confirm(confirmMsg)) return;
    try {
      var res = await safeSupa.from("announcements").delete().eq("id", id);
      if (res.error) throw res.error;
      setAnnouncements(function (prev) { return prev.filter(function (a) { return a.id !== id; }); });
      showToast(rtl ? "\u062a\u0645 \u0627\u0644\u062d\u0630\u0641" : "Deleted", "success");
    } catch (e) {
      showToast((rtl ? "\u062e\u0637\u0623: " : "Error: ") + (e.message || ""), "error");
    }
  ...
  /* V3.4 — Admin: Toggle announcement active status */
  async function handleToggleAnnouncement(id, currentActive) {
    if (!safeSupa) return;
    try {
      var res = await safeSupa
        .from("announcements")
      ...
      setAnnouncements(function (prev) {
        return prev.map(function (a) {
          return a.id === id ? Object.assign({}, a, { is_active: !currentActive }) : a;
        });
      });
    } catch (e) {
      showToast((rtl ? "\u062e\u0637\u0623: " : "Error: ") + (e.message || ""), "error");
  ...
  /* === GENERATION === */
  var PASTE_TOOLS = ["viral", "remix", "summary", "titles", "thread", "linkedin", "repurpose"];
  /* V3.0 — Single source of truth: tools that use mood (for UI + prompt + DB consistency).
     NOTE: Paste tools that show mood dropdown = MOOD_TOOLS intersected with PASTE_TOOLS.
     Generate tool is not in paste group but always uses mood. */
  var MOOD_TOOLS = ["generate", "remix", "viral", "titles", "thread", "linkedin", "repurpose"];
  ...
  function buildPrompt(toolParam) {
    ...
    if (currentTool === "viral") {
      return "Analyze the viral potential of this content. Give a score from 1-100 with detailed feedback. Tone: " + mood + ". Respond in " + language + ".\n\n" + pasteText;
    }
    ...
    if (currentTool === "titles") {
      return "Generate 10 click-worthy, SEO-optimized titles for this content. Tone: " + mood + ". Language: " + language + ".\n\n" + (pasteText || topic);
    }
    if (currentTool === "thread") {
      return "Convert this into a Twitter/X thread of 8-12 tweets. Make each tweet engaging. Tone: " + mood + ". Language: " + language + ".\n\n" + pasteText;
    }
    if (currentTool === "linkedin") {
      return "Convert this into a professional LinkedIn post with hooks and hashtags. Tone: " + mood + ". Language: " + language + ".\n\n" + pasteText;
    }
    if (currentTool === "repurpose") {
      return "You are a content strategist. Repurpose the content below into 5 DIFFERENT, COMPLETE, and READY-TO-PUBLISH formats. Each format must stand alone with its own tone and structure. Use clear emoji-labeled section headings EXACTLY as shown below (do not skip any). Write everything in " + language + " language. Overall tone: " + mood + ".\n\n" +
        "Format the output EXACTLY like this:\n\n" +
        "## 1\ufe0f\u20e3 \ud83d\udcdd Blog Post\n" +
        "(400-600 words. Hook intro, 3 subheadings, engaging conclusion with CTA.)\n\n" +
        "## 2\ufe0f\u20e3 \ud83d\udce2 Social Media Post\n" +
        "(Max 150 words. Punchy opener, value bullets, 5-7 hashtags at the end.)\n\n" +
        "## 3\ufe0f\u20e3 \u2709\ufe0f Email Newsletter\n" +
        "(Subject line + greeting + body + CTA. Friendly conversational tone.)\n\n" +
        "## 4\ufe0f\u20e3 \ud83c\udfa5 Video Script\n" +
        "(60-90 seconds. [HOOK 0:00], [MAIN 0:10], [CTA 0:50]. Spoken tone.)\n\n" +
        "## 5\ufe0f\u20e3 \ud83c\udfa7 Podcast Outline\n" +
        "(Intro + 3 key talking points with sub-bullets + wrap-up. Conversational.)\n\n" +
        "Make each format feel native to its platform. NO summaries, NO fluff, NO meta-commentary. Deliver the actual content.\n\n" +
        "---\nSOURCE CONTENT:\n" + pasteText;
    }
  ...
  async function saveArticle(toolType, content) {
    ...
    /* V3.0 — Only persist mood for tools that actually use it.
       Uses the single source of truth MOOD_TOOLS defined above. */
    var effectiveMood = MOOD_TOOLS.indexOf(toolType) !== -1 ? mood : null;
    ...
    var newArticle = {
      ...
      mood: effectiveMood,
      era: era,
      /* V3.2 — Unified field name 'words' to match DB column.
         UI readers use (words || word_count) for backward compat. */
      words: storedWordCount,
    ...
    if (safeDb && user) {
      try {
        /* V3.2 — Pass article as object (matches lib/db.js saveArticle signature).
           Previous version passed 6 separate args which caused silent DB failure. */
        await safeDb.saveArticle(user.id, {
          topic: topicLabel,
          content: content,
          language: language,
          mood: effectiveMood,
  ...
  async function handleGenerate(toolOverride) {
    ...
    try {
      var resp = await fetch("/api/generate", {
        ...
        body: JSON.stringify({
          prompt: buildPrompt(currentTool),
  ...
  return (
    <div style={{
      ...
      {/* V3.4 — Announcement Modal (popup, dismissible) */}
      {visibleModal && (
        <div style={{
          ...
          <div style={{
            background: TH.card, borderRadius: "16px",
            ...
            <h2 style={{
              ...
              marginBottom: "10px", color: TH.text,
            }}>{annTitle(visibleModal)}</h2>
            <p style={{
              fontSize: "0.9rem", color: TH.text,
              lineHeight: 1.6, marginBottom: "20px",
              whiteSpace: "pre-wrap", textAlign: "center",
            }}>{annMessage(visibleModal)}</p>
            <button
              onClick={function () { dismissAnnouncement(visibleModal.id); }}
      ...
      <main style={{ paddingTop: "56px", minHeight: "calc(100vh - 140px)" }}>
        ...
        {/* V3.4 — Dashboard announcement card (shown on all logged-in views except landing) */}
        {visibleBanner && view !== "landing" && (
          <div style={{
            maxWidth: "750px", margin: "20px auto 0", padding: "0 16px",
          }}>
            <style>{"@keyframes oxAnnounceFadeIn { from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); } }"}</style>
            <div style={{
              background: TH.card,
              border: "1px solid " + TH.border,
              borderRadius: "14px",
              padding: "14px 18px",
              boxShadow: "0 4px 16px rgba(91,108,240,0.08)",
              borderInlineStart: "4px solid " + TH.primary,
              textAlign: rtl ? "right" : "left",
              position: "relative",
              display: "flex", alignItems: "flex-start", gap: "12px",
              animation: "oxAnnounceFadeIn 0.4s ease-out",
            }}>
              <span style={{ fontSize: "1.2rem", flexShrink: 0, marginTop: "1px" }}>📢</span>
              <div style={{ flex: 1, minWidth: 0, paddingInlineEnd: "20px" }}>
                <h4 style={{
                  fontFamily: "'Source Serif 4', serif",
                  fontWeight: 700, fontSize: "0.95rem",
                  color: TH.text, margin: "0 0 4px",
                }}>{annTitle(visibleBanner)}</h4>
                <p style={{
                  fontSize: "0.82rem", color: TH.textSec,
                  lineHeight: 1.5, margin: 0,
                  whiteSpace: "pre-wrap",
                }}>{annMessage(visibleBanner)}</p>
              </div>
              <button
                onClick={function () { dismissAnnouncement(visibleBanner.id); }}
                style={{
                  position: "absolute",
                  top: "10px",
                  right: rtl ? undefined : "10px",
                  left: rtl ? "10px" : undefined,
                  background: "transparent", border: "none",
                  color: TH.textSec, cursor: "pointer",
        ...
        {view === "landing" && (
          <div>
            ...
            <section style={{
              ...
              {/* V3.4 — Hero Layout: Hero + Announcement Card side-by-side (desktop) */}
              <div style={{
                position: "relative",
                maxWidth: visibleBanner ? "1100px" : "700px",
                margin: "0 auto",
                display: "flex",
                alignItems: "center",
                ...
                {/* Hero content */}
                <div style={{ flex: "1 1 320px", minWidth: 0, maxWidth: "700px" }}>
                ...
                {/* V3.4 — Announcement Card beside Hero (landing) */}
                {visibleBanner && (
                  <div style={{
                    flex: "0 1 340px",
                    minWidth: "280px",
                    ...
                    borderRadius: "16px",
                    padding: "18px 20px",
                    boxShadow: "0 10px 30px rgba(91,108,240,0.12)",
                    borderInlineStart: "4px solid " + TH.primary,
                    textAlign: rtl ? "right" : "left",
                    position: "relative",
                    animation: "oxAnnounceFadeIn 0.5s ease-out",
                  }}>
                    <style>{"@keyframes oxAnnounceFadeIn { from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); } }"}</style>
                    <button
                      onClick={function () { dismissAnnouncement(visibleBanner.id); }}
                      ...
                      onMouseEnter={function (e) { e.currentTarget.style.background = TH.border; }}
                    ...
                    <p style={{
                      fontSize: "0.88rem", color: TH.textSec,
            ...
            <section style={{
              ...
              {[
                { n: "29", l: rtl ? "\u0644\u063a\u0629" : "Languages" },
                { n: "31", l: rtl ? "\u062d\u0642\u0628\u0629" : "Eras" },
                { n: "8", l: rtl ? "\u0623\u062f\u0627\u0629 AI" : "AI Tools" },
        ...
        {view === "writer" && (
          <div style={{ padding: "24px 16px 40px", maxWidth: "750px", margin: "0 auto" }}>
            ...
            {/* V3.5 — Tool selector: Grid of tool cards (responsive) */}
            <div style={{
              display: "grid",
                  ...
                  <button
                    ...
                    onMouseEnter={function (e) {
                      if (!isActive) {
                        ...
                        e.currentTarget.style.boxShadow = "0 6px 14px rgba(91,108,240,0.15)";
                      }
                    }}
                    ...
                    style={{
                      ...
                      minHeight: "88px",
                      borderRadius: "14px",
                      border: "1.5px solid " + (isActive ? TH.primary : TH.border),
                      background: isActive
                        ? (darkMode ? "rgba(91,108,240,0.15)" : "rgba(91,108,240,0.08)")
                        : TH.card,
                      color: TH.text,
                      cursor: "pointer",
                      ...
                      position: "relative",
                      fontFamily: "inherit",
                      boxShadow: isActive ? "0 4px 12px rgba(91,108,240,0.25)" : "none",
                    }}
                  >
                    {/* Icon */}
                    <div style={{
                      ...
                      {tl.svgIcon === "x"
                        ? <XLogo size={24} color={isActive ? TH.primary : TH.text} />
                        : tl.svgIcon === "linkedin"
                    ...
                    <div style={{
                      ...
                      color: isActive ? TH.primary : TH.text,
                      textAlign: "center",
                      lineHeight: 1.2,
                      overflow: "hidden",
                    ...
                    <div style={{
                      fontSize: "0.62rem",
                      fontWeight: 700,
                      color: isActive ? "#fff" : TH.textSec,
                      background: isActive ? TH.primary : (darkMode ? "rgba(255,255,255,0.06)" : "rgba(0,0,0,0.04)"),
                      padding: "1px 8px",
                      borderRadius: "10px",
                      minWidth: "22px",
                      textAlign: "center",
            ...
            {/* V3.0 — Tool description banner: shows above the active tool inputs */}
            {(function () {
              var active = TOOLS.filter(function (tl) { return tl.id === activeTool; })[0];
              if (!active) return null;
              var desc = rtl ? active.descAr : active.descEn;
              if (!desc) return null;
              return (
                <div style={{
                  padding: "12px 14px", marginBottom: "18px",
                  borderRadius: "12px",
                  background: darkMode ? "rgba(91,108,240,0.08)" : "rgba(91,108,240,0.05)",
                  border: "1px solid " + TH.primary + "30",
                  display: "flex", alignItems: "flex-start", gap: "10px",
                }}>
                  <div style={{ fontSize: "1rem", flexShrink: 0, paddingTop: "1px", display: "inline-flex", alignItems: "center" }}>
                    {active.svgIcon === "x"
                      ? <XLogo size={16} color={TH.text} />
                      : active.svgIcon === "linkedin"
                        ? <LinkedInLogo size={16} />
                        : <span>{active.icon}</span>}
                  </div>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontWeight: 700, fontSize: "0.85rem", marginBottom: "3px", color: TH.text }}>
                      {(rtl ? active.ar : active.en) + " \u2022 " + active.cost + " \ud83e\ude99"}
                    </div>
                    <div style={{ fontSize: "0.8rem", color: TH.textSec, lineHeight: 1.55 }}>
                      {desc}
                    </div>
                  </div>
                </div>
            ...
            {/* Topic input */}
            {(activeTool === "generate" || activeTool === "titles") && (
              <input
                value={topic}
            ...
            {/* V3.0 — Language + Mood for eligible paste tools. Mood shown for tools in MOOD_TOOLS (single source of truth). Excluded: roast (has levels), summary (neutral by nature) */}
            {PASTE_TOOLS.indexOf(activeTool) !== -1 && (function () {
              var showMood = MOOD_TOOLS.indexOf(activeTool) !== -1;
              return (
                <div style={{
                  display: "grid",
                  gridTemplateColumns: showMood ? "repeat(auto-fit, minmax(160px, 1fr))" : "1fr",
              ...
              <div style={{
                ...
                <div>
                  ...
                  <select value={era} onChange={function (e) { setEra(e.target.value); }} style={inputStyle}>
                    {ERA_LIST.map(function (e) { return <option key={e} value={e}>{eraEmoji(e) + " " + e}</option>; })}
                  </select>
                </div>
                <div>
                  <label style={{ color: TH.textSec, fontSize: "0.8rem", display: "block", marginBottom: "6px" }}>
                ...
                <div>
                  ...
                  <select value={gender} onChange={function (e) { setGender(e.target.value); }} style={inputStyle}>
                    <option value="neutral">{GENDER_EMOJI.neutral + " " + t("neutral")}</option>
                    <option value="male">{GENDER_EMOJI.male + " " + t("male")}</option>
                    <option value="female">{GENDER_EMOJI.female + " " + t("female")}</option>
                  </select>
                </div>
              </div>
            )}
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", gap: "10px" }}>
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <div style={{ color: TH.textSec, fontSize: "0.8rem" }}>
                              {(art.language || "") + " \u2022 " + (art.mood ? ((MOOD_EMOJI[art.mood] ? MOOD_EMOJI[art.mood] + " " : "") + (rtl ? (MOOD_AR[art.mood] || art.mood) : art.mood)) : "-") + " \u2022 " + (art.words != null ? art.words : (art.word_count || "?")) + " " + t("words")}
                            </div>
                          </div>
          ...
          <div style={{ padding: "24px 16px 40px", maxWidth: "800px", margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", gap: "6px", marginBottom: "24px", flexWrap: "wrap" }}>
              {[
                ...
                { id: "announcements", l: (rtl ? "\u0625\u0639\u0644\u0627\u0646\u0627\u062a" : "Announcements"), ic: "\ud83d\udce2" },
              ].map(function (tab) {
                return (
                  <button
                    key={tab.id}
            ...
            {adminTab === "dashboard" && (
              <div>
                ...
                {/* V3.1 — Claude API Usage tracking */}
                <div style={cardStyle}>
                  ...
                  {loadingApi && (
                    <p style={{ textAlign: "center", color: TH.textSec, fontSize: "0.85rem", padding: "20px" }}>
                    ...
                    <>
                      ...
                      <div style={{
                        ...
                        <div style={{
                          ...
                          background: apiStats.balance < apiStats.threshold ? "rgba(239,68,68,0.08)" : "rgba(34,197,94,0.08)",
                          border: "1px solid " + (apiStats.balance < apiStats.threshold ? "rgba(239,68,68,0.3)" : "rgba(34,197,94,0.3)"),
                        }}>
                          <div style={{ color: TH.textSec, fontSize: "0.75rem", marginBottom: "4px" }}>
                            {rtl ? "\u0631\u0635\u064a\u062f Anthropic" : "Anthropic Balance"}
                          </div>
                          <div style={{
                            fontWeight: 800, fontSize: "1.5rem",
                            color: apiStats.balance < apiStats.threshold ? "#EF4444" : "#22C55E",
                          }}>{"$" + (apiStats.balance || 0).toFixed(2)}</div>
                          {apiStats.balance < apiStats.threshold && (
                            <div style={{
                              marginTop: "6px", fontSize: "0.72rem", fontWeight: 700,
                              color: "#EF4444",
                            }}>
                              {"\u26a0\ufe0f " + (rtl
                                ? "\u0627\u0644\u0631\u0635\u064a\u062f \u0645\u0646\u062e\u0641\u0636! \u062d\u0627\u0646 \u0648\u0642\u062a \u0627\u0644\u0634\u062d\u0646."
                        ...
                        <div style={{
                          ...
                          <div style={{ fontWeight: 800, fontSize: "1.5rem", color: TH.primary }}>
                            {"$" + (apiStats.monthCost || 0).toFixed(4)}
                          </div>
                          <div style={{ fontSize: "0.72rem", color: TH.textSec, marginTop: "4px" }}>
                            {(apiStats.monthTokensInput + apiStats.monthTokensOutput).toLocaleString() + " "
                              + (rtl ? "tokens" : "tokens")}
                          </div>
                        </div>
                      </div>
                      ...
                      <div style={{
                        ...
                        <div style={{ color: TH.textSec, fontSize: "0.75rem", marginBottom: "10px" }}>
                          {rtl ? "\u0622\u062e\u0631 30 \u064a\u0648\u0645" : "Last 30 days"}
                        </div>
                        {(function () {
                          var maxCost = 0;
                          apiStats.dailySeries.forEach(function (d) { if (d.cost > maxCost) maxCost = d.cost; });
                          if (maxCost === 0) maxCost = 1; /* avoid div-by-0 */
                          return (
                            <div style={{
                              display: "flex", alignItems: "flex-end", gap: "2px",
                              height: "80px",
                              direction: "ltr", /* always LTR for chart */
                            }}>
                              {apiStats.dailySeries.map(function (d, i) {
                                var h = Math.max(2, (d.cost / maxCost) * 100);
                                return (
                                  <div key={i}
                                    ...
                                    style={{
                                      flex: 1,
                                      height: h + "%",
                                      background: d.cost > 0 ? TH.primary : TH.border,
                                      borderRadius: "2px 2px 0 0",
                                      opacity: d.cost > 0 ? 1 : 0.3,
                                    }}
                                  />
                                );
                              })}
                        ...
                        <div style={{
                          display: "flex", justifyContent: "space-between",
                          fontSize: "0.65rem", color: TH.textSec, marginTop: "6px",
                          direction: "ltr",
                        }}>
                          <span>{apiStats.dailySeries[0] ? apiStats.dailySeries[0].date.slice(5) : ""}</span>
                          <span>{rtl ? "\u0627\u0644\u064a\u0648\u0645" : "Today"}</span>
                        </div>
                      </div>
                      ...
                      <div style={{
                        ...
                        <div style={{ color: TH.textSec, fontSize: "0.75rem", marginBottom: "10px", fontWeight: 700 }}>
                          {"\ud83c\udfc6 " + (rtl ? "\u0623\u0643\u062b\u0631 10 \u0645\u0633\u062a\u062e\u062f\u0645\u064a\u0646" : "Top 10 Users (this month)")}
                        </div>
                        {apiStats.topUsers.length === 0 && (
                          <p style={{ fontSize: "0.8rem", color: TH.textSec, textAlign: "center", padding: "12px" }}>
                            {rtl ? "\u0644\u0627 \u064a\u0648\u062c\u062f \u0627\u0633\u062a\u0647\u0644\u0627\u0643 \u0647\u0630\u0627 \u0627\u0644\u0634\u0647\u0631" : "No usage this month"}
                          </p>
                        )}
                        {apiStats.topUsers.map(function (u, i) {
                          return (
                            <div key={i} style={{
                              display: "flex", justifyContent: "space-between", alignItems: "center",
                              padding: "8px 0",
                              borderBottom: i < apiStats.topUsers.length - 1 ? "1px solid " + TH.border : "none",
                              fontSize: "0.82rem",
                            }}>
                              ...
                              <div style={{ textAlign: rtl ? "left" : "right", flexShrink: 0, marginInlineStart: "10px" }}>
                                <div style={{ fontWeight: 700, color: TH.primary }}>{"$" + u.cost.toFixed(4)}</div>
                                <div style={{ fontSize: "0.68rem", color: TH.textSec }}>
                      ...
                      <div style={{
                        ...
                        <div style={{
                          ...
                          <div>
                            <label style={{ fontSize: "0.7rem", color: TH.textSec, display: "block", marginBottom: "3px" }}>
                              {rtl ? "\u0631\u0635\u064a\u062f \u062c\u062f\u064a\u062f ($)" : "New Balance ($)"}
                            </label>
                            <input
                              type="number" step="0.01"
                              value={apiSettingsEdit.balance}
                              onChange={function (e) { setApiSettingsEdit(Object.assign({}, apiSettingsEdit, { balance: e.target.value })); }}
                              placeholder={String((apiStats.balance || 0).toFixed(2))}
                              style={Object.assign({}, inputStyle, { marginBottom: 0, fontSize: "0.85rem", padding: "8px 10px" })}
                            />
                          </div>
                          <div>
                            <label style={{ fontSize: "0.7rem", color: TH.textSec, display: "block", marginBottom: "3px" }}>
                              {rtl ? "Input $/1M" : "Input $/1M"}
                            </label>
                            <input
                              type="number" step="0.01"
                              value={apiSettingsEdit.inputPrice}
                              onChange={function (e) { setApiSettingsEdit(Object.assign({}, apiSettingsEdit, { inputPrice: e.target.value })); }}
                              placeholder={String(apiStats.inputPrice)}
                              style={Object.assign({}, inputStyle, { marginBottom: 0, fontSize: "0.85rem", padding: "8px 10px" })}
                            />
                          </div>
                          <div>
                            <label style={{ fontSize: "0.7rem", color: TH.textSec, display: "block", marginBottom: "3px" }}>
                              {rtl ? "Output $/1M" : "Output $/1M"}
                            </label>
                            <input
                              type="number" step="0.01"
                              value={apiSettingsEdit.outputPrice}
                              onChange={function (e) { setApiSettingsEdit(Object.assign({}, apiSettingsEdit, { outputPrice: e.target.value })); }}
                              placeholder={String(apiStats.outputPrice)}
                              style={Object.assign({}, inputStyle, { marginBottom: 0, fontSize: "0.85rem", padding: "8px 10px" })}
                            />
                          </div>
                          <div>
                            <label style={{ fontSize: "0.7rem", color: TH.textSec, display: "block", marginBottom: "3px" }}>
                              {rtl ? "\u062d\u062f \u0627\u0644\u062a\u062d\u0630\u064a\u0631 ($)" : "Warn Below ($)"}
                            </label>
                            <input
                              type="number" step="0.01"
                              value={apiSettingsEdit.threshold}
                              onChange={function (e) { setApiSettingsEdit(Object.assign({}, apiSettingsEdit, { threshold: e.target.value })); }}
                              placeholder={String(apiStats.threshold)}
                              style={Object.assign({}, inputStyle, { marginBottom: 0, fontSize: "0.85rem", padding: "8px 10px" })}
                            />
                          </div>
                        </div>
                        ...
                        >{rtl ? "\ud83d\udcbe \u062d\u0641\u0638 \u0627\u0644\u0625\u0639\u062f\u0627\u062f\u0627\u062a" : "\ud83d\udcbe Save Settings"}</button>
                        <p style={{ fontSize: "0.68rem", color: TH.textSec, marginTop: "8px", textAlign: "center" }}>
                          {rtl
                            ? "\u0627\u062a\u0631\u0643 \u0623\u064a \u062d\u0642\u0644 \u0641\u0627\u0631\u063a \u0625\u0630\u0627 \u0644\u0645 \u062a\u0631\u062f \u062a\u063a\u064a\u064a\u0631\u0647"
                            : "Leave any field empty to keep current value"}
                        </p>
                      </div>
                    </>
                  )}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
                          ...
                          {/* V3.3 — Delete message */}
                          <button
                            onClick={function (e) { e.stopPropagation(); deleteMessage(msg.id); }}
                            onMouseEnter={onHoverIn} onMouseLeave={onHoverOut}
                            style={Object.assign({}, btnBase, {
                              padding: "4px 12px", borderRadius: "6px",
            ...
            {/* V3.4 — Announcements tab */}
            {adminTab === "announcements" && (
              <div>
                <h3 style={{ fontWeight: 700, marginBottom: "14px", fontSize: "1rem" }}>
                  {"\ud83d\udce2 " + (rtl ? "\u0625\u0639\u0644\u0627\u0646\u0627\u062a \u0644\u0644\u0645\u0633\u062a\u062e\u062f\u0645\u064a\u0646" : "Announcements to Users")}
                </h3>

                {/* Create form */}
                <div style={Object.assign({}, cardStyle, { marginBottom: "18px" })}>
                  <h4 style={{ fontWeight: 700, marginBottom: "12px", fontSize: "0.9rem" }}>
                    {"\u2795 " + (rtl ? "\u0625\u0646\u0634\u0627\u0621 \u0625\u0639\u0644\u0627\u0646 \u062c\u062f\u064a\u062f" : "Create New Announcement")}
                  </h4>
                  ...
                  <div style={{
                    ...
                    <div style={{
                      fontSize: "0.7rem", color: TH.primary, fontWeight: 700,
                      marginBottom: "8px", letterSpacing: "0.5px",
                    }}>🇬🇧 ENGLISH</div>
                    <label style={{ fontSize: "0.72rem", color: TH.textSec, display: "block", marginBottom: "3px" }}>Title</label>
                    <input
                      value={announceForm.title}
                      onChange={function (e) { setAnnounceForm(Object.assign({}, announceForm, { title: e.target.value })); }}
                      placeholder="e.g. New Update"
                      dir="ltr"
                      style={Object.assign({}, inputStyle, { marginBottom: "8px" })}
                    />
                    <label style={{ fontSize: "0.72rem", color: TH.textSec, display: "block", marginBottom: "3px" }}>Message</label>
                    <textarea
                      value={announceForm.message}
                      onChange={function (e) { setAnnounceForm(Object.assign({}, announceForm, { message: e.target.value })); }}
                      placeholder="Write announcement text..."
                      rows={2}
                      dir="ltr"
                      style={Object.assign({}, inputStyle, { marginBottom: 0, fontFamily: "inherit", resize: "vertical" })}
                    />
                  </div>
                  ...
                  <div style={{
                    padding: "10px 12px", borderRadius: "10px",
                    background: "rgba(155,123,240,0.04)",
                    border: "1px solid " + TH.border,
                    marginBottom: "10px",
                  }}>
                    <div style={{
                      fontSize: "0.7rem", color: TH.secondary, fontWeight: 700,
                      marginBottom: "8px", letterSpacing: "0.5px",
                    }}>🇪🇬 العربية</div>
                    <label style={{ fontSize: "0.72rem", color: TH.textSec, display: "block", marginBottom: "3px" }}>العنوان</label>
                    <input
                      value={announceForm.title_ar}
                      onChange={function (e) { setAnnounceForm(Object.assign({}, announceForm, { title_ar: e.target.value })); }}
                      placeholder="مثال: تحديث جديد"
                      dir="rtl"
                      style={Object.assign({}, inputStyle, { marginBottom: "8px", textAlign: "right" })}
                    />
                    <label style={{ fontSize: "0.72rem", color: TH.textSec, display: "block", marginBottom: "3px" }}>الرسالة</label>
                    <textarea
                      value={announceForm.message_ar}
                      onChange={function (e) { setAnnounceForm(Object.assign({}, announceForm, { message_ar: e.target.value })); }}
                      placeholder="اكتب نص الإعلان..."
                      rows={2}
                      dir="rtl"
                      style={Object.assign({}, inputStyle, { marginBottom: 0, fontFamily: "inherit", resize: "vertical", textAlign: "right" })}
                    />
                  </div>

                  <p style={{ fontSize: "0.68rem", color: TH.textSec, marginBottom: "10px", lineHeight: 1.5 }}>
                    {rtl
                      ? "\u062a\u0644\u0645\u064a\u062d: \u0625\u0630\u0627 \u062a\u0631\u0643\u062a \u0625\u062d\u062f\u0649 \u0627\u0644\u0644\u063a\u062a\u064a\u0646 \u0641\u0627\u0631\u063a\u0629\u060c \u0633\u064a\u062a\u0645 \u0627\u0633\u062a\u062e\u062f\u0627\u0645 \u0627\u0644\u0623\u062e\u0631\u0649 \u0628\u062f\u0644\u0627\u064b \u0645\u0646\u0647\u0627."
                      : "Tip: If you leave one language empty, the other will be used as fallback."}
                  </p>
                  ...
                  <div style={{
                    ...
                    <div>
                      <label style={{ fontSize: "0.72rem", color: TH.textSec, display: "block", marginBottom: "3px" }}>
                        {rtl ? "\u0627\u0644\u0646\u0648\u0639" : "Type"}
                      </label>
                      <select
                        value={announceForm.type}
                        onChange={function (e) { setAnnounceForm(Object.assign({}, announceForm, { type: e.target.value })); }}
                        style={Object.assign({}, inputStyle, { marginBottom: 0, fontSize: "0.85rem", padding: "9px 10px" })}
                      >
                        <option value="notification">{"\ud83d\udd14 " + (rtl ? "\u0625\u0634\u0639\u0627\u0631" : "Notification")}</option>
                        <option value="banner">{"\ud83d\udccc " + (rtl ? "\u0628\u0627\u0646\u0631" : "Banner")}</option>
                        <option value="modal">{"\ud83d\udda5\ufe0f " + (rtl ? "\u0646\u0627\u0641\u0630\u0629" : "Modal Popup")}</option>
                      </select>
                    </div>
                    <div>
                      <label style={{ fontSize: "0.72rem", color: TH.textSec, display: "block", marginBottom: "3px" }}>
                        {rtl ? "\u0627\u0644\u062e\u0637\u0629" : "Target Plan"}
                      </label>
                      <select
                        value={announceForm.target_plan}
                        onChange={function (e) { setAnnounceForm(Object.assign({}, announceForm, { target_plan: e.target.value })); }}
                        style={Object.assign({}, inputStyle, { marginBottom: 0, fontSize: "0.85rem", padding: "9px 10px" })}
                      >
                        <option value="all">{PLAN_EMOJI.all + " " + (rtl ? "\u0627\u0644\u062c\u0645\u064a\u0639" : "All Users")}</option>
                        <option value="free">{PLAN_EMOJI.free + " Free"}</option>
                        <option value="starter">{PLAN_EMOJI.starter + " Starter"}</option>
                        <option value="pro">{PLAN_EMOJI.pro + " Pro"}</option>
                        <option value="agency">{PLAN_EMOJI.agency + " Agency"}</option>
                      </select>
                    </div>
                    <div>
                      <label style={{ fontSize: "0.72rem", color: TH.textSec, display: "block", marginBottom: "3px" }}>
                      ...
                      <select
                        value={announceForm.target_language}
                        onChange={function (e) { setAnnounceForm(Object.assign({}, announceForm, { target_language: e.target.value })); }}
                        style={Object.assign({}, inputStyle, { marginBottom: 0, fontSize: "0.85rem", padding: "9px 10px" })}
                      >
                        <option value="all">{"\ud83c\udf10 " + (rtl ? "\u0627\u0644\u0627\u062b\u0646\u0627\u0646" : "Both")}</option>
                        <option value="en">{"\ud83c\uddec\ud83c\udde7 English"}</option>
                        <option value="ar">{"\ud83c\uddea\ud83c\uddec " + (rtl ? "\u0627\u0644\u0639\u0631\u0628\u064a\u0629" : "Arabic")}</option>
                      </select>
                    </div>
                    <div>
                      <label style={{ fontSize: "0.72rem", color: TH.textSec, display: "block", marginBottom: "3px" }}>
                        {rtl ? "\u062a\u0627\u0631\u064a\u062e \u0627\u0644\u0627\u0646\u062a\u0647\u0627\u0621 (\u0627\u062e\u062a\u064a\u0627\u0631\u064a)" : "Expires (optional)"}
                      </label>
                      <input
                        type="date"
                        value={announceForm.expires_at}
                        onChange={function (e) { setAnnounceForm(Object.assign({}, announceForm, { expires_at: e.target.value })); }}
                        style={Object.assign({}, inputStyle, { marginBottom: 0, fontSize: "0.85rem", padding: "9px 10px" })}
                      />
                    </div>
                  </div>
                  ...
                  >{"\ud83d\ude80 " + (rtl ? "\u0646\u0634\u0631 \u0627\u0644\u0625\u0639\u0644\u0627\u0646" : "Publish Announcement")}</button>
                </div>

                {/* Existing announcements list */}
                <h4 style={{ fontWeight: 700, marginBottom: "10px", fontSize: "0.9rem" }}>
                  {(rtl ? "\u0627\u0644\u0625\u0639\u0644\u0627\u0646\u0627\u062a \u0627\u0644\u062d\u0627\u0644\u064a\u0629" : "Current Announcements") + " (" + announcements.length + ")"}
                </h4>
                ...
                {!loadingAnnouncements && announcements.length === 0 && (
                  <p style={{ textAlign: "center", color: TH.textSec, fontSize: "0.85rem", padding: "20px" }}>
                    {rtl ? "\u0644\u0627 \u062a\u0648\u062c\u062f \u0625\u0639\u0644\u0627\u0646\u0627\u062a \u0628\u0639\u062f" : "No announcements yet"}
                  </p>
                )}

                {announcements.map(function (a) {
                  var typeIcon = a.type === "banner" ? "\ud83d\udccc" : a.type === "modal" ? "\ud83d\udda5\ufe0f" : "\ud83d\udd14";
                  var typeLabel = a.type === "banner" ? (rtl ? "\u0628\u0627\u0646\u0631" : "Banner")
                                : a.type === "modal" ? (rtl ? "\u0646\u0627\u0641\u0630\u0629" : "Modal")
                                : (rtl ? "\u0625\u0634\u0639\u0627\u0631" : "Notification");
                  var expiredSoon = a.expires_at && new Date(a.expires_at) < new Date();
                  return (
                    <div key={a.id} style={Object.assign({}, cardStyle, {
                      marginBottom: "10px",
                      opacity: a.is_active && !expiredSoon ? 1 : 0.55,
                      borderInlineStart: "3px solid " + (a.is_active && !expiredSoon ? TH.primary : TH.border),
                    })}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "10px", marginBottom: "6px" }}>
                        <h5 style={{ fontWeight: 700, fontSize: "0.95rem", margin: 0, flex: 1 }}>
                          {annTitle(a)}
                        </h5>
                        <span style={{ fontSize: "0.68rem", color: TH.textSec, whiteSpace: "nowrap" }}>
                          {typeIcon + " " + typeLabel}
                        </span>
                      </div>
                      <p style={{ fontSize: "0.83rem", color: TH.text, marginBottom: "6px", whiteSpace: "pre-wrap" }}>
                        {annMessage(a)}
                      </p>
                      {/* Show other language preview */}
                      {(rtl ? (a.title || a.message) : (a.title_ar || a.message_ar)) && (
                        <p style={{
                          fontSize: "0.75rem", color: TH.textSec,
                          marginBottom: "8px", whiteSpace: "pre-wrap",
                          borderInlineStart: "2px solid " + TH.border,
                          paddingInlineStart: "8px",
                          fontStyle: "italic",
                        }}>
                          <strong>{rtl ? "EN: " : "AR: "}</strong>
                          {rtl
                            ? ((a.title || "") + (a.message ? " — " + a.message : ""))
                            : ((a.title_ar || "") + (a.message_ar ? " — " + a.message_ar : ""))}
                        </p>
                      )}
                      <div style={{ fontSize: "0.7rem", color: TH.textSec, marginBottom: "10px" }}>
                        {(rtl ? "\u0627\u0644\u062e\u0637\u0629: " : "Plan: ") + (a.target_plan || "all")}
                        {" \u00b7 "}
                        {(rtl ? "\u0627\u0644\u0644\u063a\u0629: " : "Lang: ") + (a.target_language || "all")}
                        {a.expires_at && (
                          <span>{" \u00b7 " + (rtl ? "\u064a\u0646\u062a\u0647\u064a: " : "expires: ") + new Date(a.expires_at).toLocaleDateString()}</span>
                        )}
                        {!a.is_active && <span style={{ color: "#EF4444" }}>{" \u00b7 " + (rtl ? "\u0645\u0639\u0637\u0644" : "inactive")}</span>}
                        {expiredSoon && <span style={{ color: "#EF4444" }}>{" \u00b7 " + (rtl ? "\u0645\u0646\u062a\u0647\u064a" : "expired")}</span>}
                      </div>
                      <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
                        <button
                          onClick={function () { handleToggleAnnouncement(a.id, a.is_active); }}
                          onMouseEnter={onHoverIn} onMouseLeave={onHoverOut}
                          style={Object.assign({}, btnBase, {
                            padding: "4px 10px", borderRadius: "6px",
                            border: "1px solid " + (a.is_active ? "#F59E0B" : "#22C55E"),
                            background: (a.is_active ? "rgba(245,158,11,0.08)" : "rgba(34,197,94,0.08)"),
                            color: (a.is_active ? "#F59E0B" : "#22C55E"),
                            fontSize: "0.72rem", fontWeight: 600,
                          })}
                        >{a.is_active ? (rtl ? "\u23f8\ufe0f \u0625\u064a\u0642\u0627\u0641" : "\u23f8\ufe0f Pause") : (rtl ? "\u25b6\ufe0f \u062a\u0641\u0639\u064a\u0644" : "\u25b6\ufe0f Activate")}</button>
                        <button
                          onClick={function () { handleDeleteAnnouncement(a.id); }}
                          onMouseEnter={onHoverIn} onMouseLeave={onHoverOut}
                          style={Object.assign({}, btnBase, {
                            padding: "4px 10px", borderRadius: "6px",
                            border: "1px solid #EF4444", background: "rgba(239,68,68,0.08)",
        ...
        {view === "credits" && (
          <div style={{ padding: "24px 16px 40px", maxWidth: "560px", margin: "0 auto" }}>
            ...
            <div style={cardStyle}>
              ...
              {/* V3.5 — Tool Costs: Grid cards (same style as Writer tools) */}
              <div style={{
                display: "grid",
                gridTemplateColumns: "repeat(auto-fit, minmax(78px, 1fr))",
                gap: "10px",
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{
                        ...
                        fontWeight: 800,
                        color: TH.primary,
                        background: darkMode ? "rgba(91,108,240,0.15)" : "rgba(91,108,240,0.08)",
                        padding: "2px 8px",
                        borderRadius: "10px",
                      }}>
                        <span>{tl.cost}</span>
        ...
        {view === "contact" && (
          <div style={{ padding: "24px 16px 40px", maxWidth: "560px", margin: "0 auto" }}>
            ...
            {/* V3.5 — Type selector: Grid cards (same style as Writer tools) */}
            <div style={{
              display: "grid",
              gridTemplateColumns: "repeat(3, 1fr)",
              gap: "10px",
              ...
              {CONTACT_TYPES.map(function (ct) {
                var isActive = contactType === ct.id;
                return (
                  <button
                    key={ct.id}
            ...
            <div style={{
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ color: TH.textSec, fontSize: "0.78rem" }}>
                  {(openArticle.language || "") + " \u2022 " + (openArticle.mood ? ((MOOD_EMOJI[openArticle.mood] ? MOOD_EMOJI[openArticle.mood] + " " : "") + (rtl ? (MOOD_AR[openArticle.mood] || openArticle.mood) : openArticle.mood)) : "-") + " \u2022 " + (openArticle.words != null ? openArticle.words : (openArticle.word_count || "?")) + " " + t("words")}
                </div>
              </div>
              <button
                onClick={function () { setOpenArticle(null); }}
