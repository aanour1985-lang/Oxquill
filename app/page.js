...
export default function Home() {
  ...
  function buildPrompt(toolParam) {
    ...
    if (currentTool === "repurpose") {
      return "Repurpose this content into 5 formats: blog post, social media post, email newsletter, video script, and podcast outline. Tone: " + mood + ". Language: " + language + ".\n\n" + pasteText;
    }
                  ...
                  <div style={{
                    ...
                    <div>
                      ...
                      <select
                        ...
                        style={Object.assign({}, inputStyle, { marginBottom: 0, fontSize: "0.85rem", padding: "9px 10px" })}
                      >
                        <option value="all">{rtl ? "\u0627\u0644\u062c\u0645\u064a\u0639" : "All Users"}</option>
