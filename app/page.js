                ...
                {activeTool === "remix" && (
                  <div>
                    ...
                    <select value={mood} onChange={function (e) { setMood(e.target.value); }} style={inputStyle}>
                      {MOOD_LIST.map(function (m) { return <option key={m} value={m}>{rtl ? (MOOD_AR[m] || m) : m}</option>; })}
                    </select>
                  </div>
                )}
              </div>
            ...
            {adminTab === "admins" && (
              <div style={cardStyle}>
                ...
                <div style={{
                  ...
                  <div>
                    <div style={{ fontWeight: 600 }}>Ahmed Nour El-Din</div>
                ...
                <div style={Object.assign({}, cardStyle, { textAlign: "center" })}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px" }}>
                      ...
                      <span style={{ fontSize: "0.7rem", color: TH.textSec }}>{rtl ? "\u0645\u0646\u0630 \u062f\u0642\u064a\u0642\u062a\u064a\u0646" : "2 min ago"}</span>
                    </div>
                    <div style={{ fontWeight: 600, fontSize: "0.85rem", marginBottom: "4px" }}>{rtl ? "\u0645\u0648\u0636\u0648\u0639 \u062a\u062c\u0631\u064a\u0628\u064a" : "Example Subject"}</div>
                    <div style={{ fontSize: "0.8rem", color: TH.textSec, marginBottom: "8px" }}>{rtl ? "\u0645\u0639\u0627\u064a\u0646\u0629 \u0627\u0644\u0631\u0633\u0627\u0644\u0629 \u0647\u0646\u0627..." : "Message preview text here..."}</div>
                    <div style={{ display: "flex", gap: "6px" }}>
