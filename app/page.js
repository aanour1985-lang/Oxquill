...
export default function Home() {
  ...
  useEffect(function () {
    if (adminTab !== "messages" || !safeSupa || !user) return;
    ...
    safeSupa
      ...
      .then(function (res) {
        if (res.data) setAdminMessages(res.data);
  ...
  useEffect(function () {
    if (adminTab !== "dashboard" || !safeSupa || !user) return;
    var isAdmin = user.isAdmin || user.email === "aanour1985@gmail.com";
    if (!isAdmin) return;
      ...
      try {
        ...
        if (creditsRes.data) {
          creditsRes.data.forEach(function (p) {
            if (p.is_admin) return; /* Skip admins — they have ∞ */
            ...
            {adminTab === "dashboard" && (
              <div>
                <div style={{
                  ...
                  {[
                    { l: t("users"), v: loadingStats ? "..." : String(adminStats.users), ic: "\ud83d\udc65", c: "#3B82F6" },
                    { l: (rtl ? "\u0625\u062c\u0645\u0627\u0644\u064a \u0627\u0644\u0645\u0642\u0627\u0644\u0627\u062a" : "Total Articles"), v: loadingStats ? "..." : String(adminStats.articles), ic: "\ud83d\udcc4", c: "#22C55E" },
                    { l: (rtl ? "\u0625\u062c\u0645\u0627\u0644\u064a \u0627\u0644\u0643\u0631\u064a\u062f\u062a\u0633" : "Total Credits"), v: loadingStats ? "..." : String(adminStats.credits), ic: "\ud83d\udcb0", c: "#F59E0B" },
                  ].map(function (stat, i) {
                    return (
                  ...
                  return filtered.map(function (msg) {
                    ...
                    var statusLabel = status === "new"
                      ...
                      : status === "read"
                        ? (rtl ? "\u0645\u0642\u0631\u0648\u0621" : "Read")
                        : (rtl ? "\u062a\u0645 \u0627\u0644\u0631\u062f" : "Replied");
                    var typeIcon = msg.type === "complaint" ? "\u26a0\ufe0f"
                      : msg.type === "question" ? "\u2753"
                      : msg.type === "bug" ? "\ud83d\udc1b"
                      : "\ud83d\udca1";
                    return (
                      ...
                      >
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px", flexWrap: "wrap", gap: "6px" }}>
                          <div style={{ display: "flex", gap: "6px", alignItems: "center", flexWrap: "wrap" }}>
                            ...
                            }}>{typeIcon + " " + (msg.type || "suggestion")}</span>
                            <span style={{
