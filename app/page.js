...
var ALL_LANGUAGES = ["English","Arabic","Spanish","French","German","Italian","Portuguese","Russian","Chinese","Japanese","Korean","Hindi","Turkish","Dutch","Swedish","Polish","Czech","Greek","Hebrew","Thai","Vietnamese","Indonesian","Malay","Filipino","Swahili","Persian","Urdu","Bengali"];
var FREE_LANGUAGES = ["English","Arabic","Spanish","French","German"];
...
var PLANS = [
  { id: "free", name: "Free", price: 0, cr: 10,
    ...
    features: { en: ["10 credits/mo","800 words max","5 languages","Watermark on content","No copy/share"], ar: ["10 \u0643\u0631\u064a\u062f\u062a/\u0634\u0647\u0631","800 \u0643\u0644\u0645\u0629 \u0645\u0627\u0643\u0633","5 \u0644\u063a\u0627\u062a","\u0639\u0644\u0627\u0645\u0629 \u0645\u0627\u0626\u064a\u0629","\u0628\u062f\u0648\u0646 \u0646\u0633\u062e/\u0645\u0634\u0627\u0631\u0643\u0629"] },
  ...
  { id: "starter", name: "Starter", price: 19, cr: 100,
    ...
    features: { en: ["100 credits/mo","2000 words","28 languages","No watermark","Copy & Share enabled"], ar: ["100 \u0643\u0631\u064a\u062f\u062a/\u0634\u0647\u0631","2000 \u0643\u0644\u0645\u0629","28 \u0644\u063a\u0629","\u0628\u062f\u0648\u0646 \u0639\u0644\u0627\u0645\u0629 \u0645\u0627\u0626\u064a\u0629","\u0646\u0633\u062e \u0648\u0645\u0634\u0627\u0631\u0643\u0629"] },
...
var TESTIMONIALS = [
  ...
  { name: "Fatima S.", nameAr: "\u0641\u0627\u0637\u0645\u0629 \u0633.", role: "Marketing Manager", roleAr: "\u0645\u062f\u064a\u0631\u0629 \u062a\u0633\u0648\u064a\u0642", text: "28 languages and it nails Arabic grammar. Finally an AI that speaks my language.", textAr: "28 \u0644\u063a\u0629 \u0648\u0628\u064a\u062a\u0642\u0646 \u0627\u0644\u0642\u0648\u0627\u0639\u062f \u0627\u0644\u0639\u0631\u0628\u064a\u0629. \u0623\u062e\u064a\u0631\u0627\u064b AI \u0628\u064a\u062a\u0643\u0644\u0645 \u0644\u063a\u062a\u064a.", stars: 5 },
];

var FEATURES = [
  { icon: "\u270d\ufe0f", en: "AI Writer", ar: "\u0643\u0627\u062a\u0628 AI", descEn: "10 AI tools, 28 languages, 6 moods", descAr: "10 \u0623\u062f\u0648\u0627\u062a AI\u060c 28 \u0644\u063a\u0629\u060c 6 \u0646\u0628\u0631\u0627\u062a", go: "writer" },
...
export default function Home() {
  ...
  var [roastLang, setRoastLang] = useState("English"); /* #1 multilang */

  /* Battle state */
  var [battleA, setBattleA] = useState("");
  var [battleB, setBattleB] = useState("");
  var [battleLang, setBattleLang] = useState("English"); /* #1 multilang */
  ...
  var [notifs, setNotifs] = useState([]); /* #2 notifications */
  ...
  async function loadUser(authUser) {
    ...
    try {
      ...
      /* FIX 4: Load existing articles from DB — try common function names */
      try {
  ...
  function buildPrompt(toolParam) {
    ...
    if (currentTool === "roast") {
      ...
      return "You are a brutally honest but hilarious writing critic. " + lvNote +
        " Respond in " + roastLang + ". Roast this article. Give it a score out of 10." +
    ...
    if (currentTool === "debate") {
      ...
      return "Create a detailed debate about: " + debateTopic + ". Language: " + battleLang +
  ...
  async function handleGenerate(toolOverride) {
    ...
    try {
      ...
      if (!resp.ok) {
        showToast("API Error: " + resp.status, "error");
        setGenerating(false);
        return;
      }
      ...
      if (extractedText && extractedText.trim()) {
        ...
        /* #2 Add notification */
        var toolLabel = toolData ? (rtl ? toolData.ar : toolData.en) : currentTool;
        setNotifs(function (prev) {
          return [{
            id: Date.now(),
            msg: toolLabel + " " + (rtl ? "\u0627\u0643\u062a\u0645\u0644! -" : "completed! -") + cost,
            time: new Date().toLocaleTimeString(),
          }].concat(prev).slice(0, 20);
        });

        /* FIX 5: Save article — local state FIRST so My Articles always works,
           then try DB save as best-effort */
        if (currentTool === "generate") {
          var newArticle = {
            id: "local_" + Date.now(),
            topic: topic,
          ...
          setArticles(function (prev) { return [newArticle].concat(prev); });
          if (safeDb && user) {
            try {
              await safeDb.saveArticle(user.id, topic, language, mood, era, wordCount, extractedText);
            } catch (e) { console.error("saveArticle failed:", e); }
          }
        }
      } else {
    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          ><><svg width="22" height="22" viewBox="0 0 24 24" fill="none" style={{verticalAlign:"middle",marginRight:rtl?0:4,marginLeft:rtl?4:0}}><circle cx="12" cy="12" r="11" fill="url(#oxlg)"/><path d="M8 16l2-8h1l2 8M9 13h3" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M15 8v8" stroke="#fff" strokeWidth="1.5" strokeLinecap="round"/><defs><linearGradient id="oxlg" x1="0" y1="0" x2="24" y2="24"><stop stopColor="#5B6CF0"/><stop offset="1" stopColor="#9B7BF0"/></linearGradient></defs></svg>{"OxQuill"}</></span>
        </div>
            ...
            <div style={{ position: "relative" }}>
              ...
              {showNotifs && (
                <div style={{
                  ...
                  zIndex: 200, maxHeight: "320px", overflowY: "auto",
                }}>
                  <div style={{
                    ...
                    {notifs.length > 0 && (
                      <button
                        onClick={function () { setNotifs([]); }}
                        style={{ background: "none", border: "none", color: TH.textSec, fontSize: "0.75rem", cursor: "pointer" }}
                      >{rtl ? "\u0645\u0633\u062d \u0627\u0644\u0643\u0644" : "Clear all"}</button>
                    )}
                  </div>
                  {notifs.length === 0 ? (
                    ...
                    notifs.map(function (nf) {
                      return (
                        <div key={nf.id} style={{
                          padding: "12px 16px",
                          borderBottom: "1px solid " + TH.border,
                        }}>
                          <div style={{ color: TH.text, fontSize: "0.85rem" }}>{nf.msg}</div>
                          <div style={{ color: TH.textSec, fontSize: "0.7rem", marginTop: "2px" }}>{nf.time}</div>
                        </div>
                      );
                    })
                  )}
              ...
              <div style={{
                ...
                <div>
                  ...
                  <select value={mood} onChange={function (e) { setMood(e.target.value); }} style={inputStyle}>
                    {MOOD_LIST.map(function (m) { return <option key={m} value={m}>{m}</option>; })}
                  </select>
                </div>
                <div>
                  <label style={{ color: TH.textSec, fontSize: "0.8rem", display: "block", marginBottom: "6px" }}>
              ...
              <div style={Object.assign({}, cardStyle, { marginTop: "24px", position: "relative" })}>
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", gap: "8px" }}>
                    {/* Download for ALL users — FIX: strong watermark in downloaded text */}
                    <button
                      onClick={function () {
                        var content = result;
                        if (hasWatermark) {
                          var header = "================================================\n" +
                                       "   OXQUILL FREE VERSION — UPGRADE TO REMOVE\n" +
                                       "   oxquill.com\n" +
                                       "================================================\n\n";
                          /* Inject [OX] every ~400 chars to prevent easy removal */
                          var parts = content.split(/\n\n+/);
                          var stamped = parts.map(function (p, i) {
                            return (i > 0 && i % 3 === 0) ? ("[OX · oxquill.com]\n\n" + p) : p;
                          }).join("\n\n");
                          content = header + stamped + "\n\n================================================\n" +
                                    "  Generated by OxQuill Free · oxquill.com\n" +
                      ...
                      style={Object.assign({}, btnBase, {
                        ...
                        color: "#F59E0B", padding: "6px 16px", borderRadius: "8px", fontSize: "0.85rem",
                      })}
                    >{"\ud83d\udcc4 " + (rtl ? "\u062a\u062d\u0645\u064a\u0644" : "Download")}</button>
                    {/* #9 Copy permission */}
                    <button
                      onClick={handleCopy}
                      onMouseEnter={onHoverIn} onMouseLeave={onHoverOut}
                      style={Object.assign({}, btnBase, {
                        background: TH.primary + "18", border: "1px solid " + TH.primary,
                        color: TH.primary, padding: "6px 16px", borderRadius: "8px", fontSize: "0.85rem",
                    ...
                    <button
                      onClick={function () {
                        if (canShare) {
                          ...
                          showToast(rtl ? "\u0631\u0642\u064a \u062e\u0637\u062a\u0643 \u0644\u0644\u0645\u0634\u0627\u0631\u0643\u0629" : "Upgrade your plan to share", "error");
                          setTimeout(function () { navigate("pricing"); }, 900);
                        }
                      }}
                      onMouseEnter={onHoverIn} onMouseLeave={onHoverOut}
                      style={Object.assign({}, btnBase, {
        ...
        {view === "roast" && (
          <div style={{ padding: "24px 16px 40px", maxWidth: "660px", margin: "0 auto", textAlign: "center" }}>
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              <select
                value={roastLang}
                onChange={function (e) { setRoastLang(e.target.value); }}
            ...
            {/* Result */}
            {result && (
              <div style={Object.assign({}, cardStyle, { marginTop: "24px", textAlign: "left", position: "relative" })}>
                {hasWatermark && (
                  <div style={{
                    position: "absolute", top: "50%", left: "50%",
                    transform: "translate(-50%,-50%) rotate(-30deg)",
                    fontSize: "1.5rem", fontWeight: 800,
                    color: "rgba(239,68,68,0.06)", pointerEvents: "none", whiteSpace: "nowrap",
                  }}>{t("watermarkText")}</div>
                )}
                <h3 style={{ color: "#EF4444", fontWeight: 700, marginBottom: "16px", fontSize: "1.1rem" }}>
                  {"\ud83d\udd25 " + t("roastResults")}
                </h3>
                <div style={{
                  lineHeight: 1.8, whiteSpace: "pre-wrap",
                ...
                <div style={{ display: "flex", gap: "8px", marginTop: "16px" }}>
                  <button onClick={function () { var c = result; if (hasWatermark) c = c + "\n\n---\n" + t("watermarkText"); var b = new Blob([c], { type: "text/plain;charset=utf-8" }); var u = URL.createObjectURL(b); var a = document.createElement("a"); a.href = u; a.download = "oxquill-roast.txt"; document.body.appendChild(a); a.click(); document.body.removeChild(a); URL.revokeObjectURL(u); showToast(rtl ? "\u062a\u0645!" : "Downloaded!", "success"); }} onMouseEnter={onHoverIn} onMouseLeave={onHoverOut} style={Object.assign({}, btnBase, { background: "rgba(245,158,11,0.1)", border: "1px solid #F59E0B", color: "#F59E0B", padding: "8px 18px", borderRadius: "8px", fontSize: "0.85rem" })}>{"\ud83d\udcc4 " + (rtl ? "\u062a\u062d\u0645\u064a\u0644" : "Download")}</button>
                  <button onClick={handleCopy} onMouseEnter={onHoverIn} onMouseLeave={onHoverOut}
                    style={Object.assign({}, btnBase, {
                      background: TH.primary + "18", border: "1px solid " + TH.primary,
                      color: TH.primary, padding: "8px 18px", borderRadius: "8px", fontSize: "0.85rem",
                      opacity: canCopy ? 1 : 0.5,
                    })}
                  >{"\ud83d\udccb " + t("copy")}</button>
                </div>
        ...
        {view === "battle" && (
          <div style={{ padding: "24px 16px 40px", maxWidth: "660px", margin: "0 auto", textAlign: "center" }}>
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              <select
                value={battleLang}
                onChange={function (e) { setBattleLang(e.target.value); }}
                style={Object.assign({}, inputStyle, { width: "auto", display: "inline-block", marginBottom: 0, padding: "10px 14px" })}
              >
                {LANGUAGES.map(function (l) { return <option key={l} value={l}>{l}</option>; })}
              </select>
            ...
            {result && (
              <div style={Object.assign({}, cardStyle, { marginTop: "24px", textAlign: "left" })}>
                <div style={{
                  lineHeight: 1.8, whiteSpace: "pre-wrap",
                  direction: rtl ? "rtl" : "ltr",
                  userSelect: canCopy ? "auto" : "none", WebkitUserSelect: canCopy ? "auto" : "none",
                ...
                <div style={{ display: "flex", gap: "8px", marginTop: "16px" }}>
                  <button onClick={function () { var c = result; if (hasWatermark) c = c + "\n\n---\n" + t("watermarkText"); var b = new Blob([c], { type: "text/plain;charset=utf-8" }); var u = URL.createObjectURL(b); var a = document.createElement("a"); a.href = u; a.download = "oxquill-battle.txt"; document.body.appendChild(a); a.click(); document.body.removeChild(a); URL.revokeObjectURL(u); showToast(rtl ? "\u062a\u0645!" : "Downloaded!", "success"); }} onMouseEnter={onHoverIn} onMouseLeave={onHoverOut} style={Object.assign({}, btnBase, { background: "rgba(245,158,11,0.1)", border: "1px solid #F59E0B", color: "#F59E0B", padding: "8px 18px", borderRadius: "8px", fontSize: "0.85rem" })}>{"\ud83d\udcc4 " + (rtl ? "\u062a\u062d\u0645\u064a\u0644" : "Download")}</button>
                  <button onClick={handleCopy} onMouseEnter={onHoverIn} onMouseLeave={onHoverOut}
                    style={Object.assign({}, btnBase, {
                      background: TH.primary + "18", border: "1px solid " + TH.primary,
                      color: TH.primary, padding: "8px 18px", borderRadius: "8px", fontSize: "0.85rem",
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", gap: "10px" }}>
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <div style={{ color: TH.textSec, fontSize: "0.8rem" }}>
                              {(art.language || "") + " \u2022 " + (art.mood || "") + " \u2022 " + (art.word_count || "?") + " " + t("words")}
                            </div>
                          </div>
        ...
        {view === "admin" && isAdminUser && (
          <div style={{ padding: "24px 16px 40px", maxWidth: "800px", margin: "0 auto" }}>
              ...
              {[
                ...
                return (
                  <button
                    ...
                    onMouseEnter={onHoverIn} onMouseLeave={onHoverOut}
                    style={Object.assign({}, chipStyle(adminTab === tab.id), btnBase, { flex: 1 })}
                  >{tab.ic + " " + tab.l}</button>
                );
              })}
            </div>
            ...
            {adminTab === "dashboard" && (
              <div>
                <div style={{
                  ...
                  {[
                    { l: t("users"), v: "0", ic: "\ud83d\udc65", c: "#3B82F6" },
                    { l: t("myArticles"), v: "0", ic: "\ud83d\udcc4", c: "#22C55E" },
                    { l: t("credits"), v: "0", ic: "\ud83d\udcb0", c: "#F59E0B" },
                  ].map(function (stat, i) {
                    return (
                      <div key={i} style={Object.assign({}, cardStyle, { textAlign: "center" })}>
                        <div style={{ fontSize: "1.4rem" }}>{stat.ic}</div>
                        <div style={{ fontSize: "1.5rem", fontWeight: 800, color: stat.c }}>{stat.v}</div>
                        <div style={{ fontSize: "0.8rem", color: TH.textSec }}>{stat.l}</div>
                      </div>
                    );
                  })}
                </div>
                ...
                <div style={cardStyle}>
                  ...
                  <div style={{
                    ...
                    <div>
                      <div style={{ color: TH.textSec, fontSize: "0.8rem" }}>Anthropic Balance</div>
                      <div style={{
            ...
            {adminTab === "users" && (
              <div style={cardStyle}>
                <div style={{
                  padding: "14px", border: "1px solid " + TH.border,
                  borderRadius: "12px", marginBottom: "10px",
                  display: "flex", justifyContent: "space-between", alignItems: "center",
                }}>
                  <div>
                    <div style={{ fontWeight: 600 }}>aanour1985@gmail.com</div>
                    <div style={{ fontSize: "0.75rem", color: TH.primary }}>{rtl ? "\u0623\u062f\u0645\u0646 \u2022 \u0646\u0634\u0637" : "Admin \u2022 Active"}</div>
                  </div>
                ...
                <p style={{ textAlign: "center", color: TH.textSec, fontSize: "0.85rem", marginTop: "16px" }}>
                  {rtl ? "\u0645\u0633\u062a\u062e\u062f\u0645\u064a\u0646 \u0625\u0636\u0627\u0641\u064a\u064a\u0646 \u0647\u064a\u0638\u0647\u0631\u0648\u0627 \u0628\u0639\u062f \u0631\u0628\u0637 Supabase" : "More users will appear after Supabase connection"}
                </p>
              </div>
            )}
            ...
            {adminTab === "admins" && (
              <div style={cardStyle}>
                ...
                <div style={{
                  ...
                  <div>
                    <div style={{ fontWeight: 600 }}>Ahmed Nour</div>
                    <div style={{ fontSize: "0.75rem", color: TH.textSec }}>aanour1985@gmail.com</div>
                    <div style={{ fontSize: "0.7rem", color: TH.primary, fontWeight: 600, marginTop: "2px" }}>
            ...
            {adminTab === "messages" && (
              <div>
                ...
                <div style={{ display: "flex", gap: "6px", marginBottom: "16px", flexWrap: "wrap" }}>
                  {[
                    { l: rtl ? "\u0627\u0644\u0643\u0644" : "All", c: "#3B82F6" },
                    { l: rtl ? "\u062c\u062f\u064a\u062f" : "New", c: "#EF4444" },
                    { l: rtl ? "\u0645\u0642\u0631\u0648\u0621" : "Read", c: "#F59E0B" },
                    { l: rtl ? "\u062a\u0645 \u0627\u0644\u0631\u062f" : "Replied", c: "#22C55E" },
                  ].map(function (f, i) {
                    return (
                      <button key={i} style={Object.assign({}, btnBase, {
                        padding: "6px 14px", borderRadius: "16px",
                        border: "1px solid " + (i === 0 ? f.c : TH.border),
                        background: i === 0 ? f.c + "14" : "transparent",
                        color: i === 0 ? f.c : TH.textSec,
                        fontSize: "0.78rem", fontWeight: i === 0 ? 700 : 500,
                      })}>{f.l}</button>
                    );
                  })}
                </div>
                ...
                <div style={Object.assign({}, cardStyle, { textAlign: "center" })}>
                  ...
                  <p style={{ color: TH.textSec, fontSize: "0.85rem", marginBottom: "16px" }}>
                    {rtl ? "\u0631\u0633\u0627\u0626\u0644 \u0627\u0644\u062a\u0648\u0627\u0635\u0644 \u0647\u062a\u0638\u0647\u0631 \u0647\u0646\u0627" : "Contact form messages will appear here"}
                  </p>
                  {/* Example message structure (dimmed) */}
                  <div style={{
                    border: "1px dashed " + TH.border, borderRadius: "12px",
                    padding: "14px", opacity: 0.5, textAlign: "left",
                  }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px" }}>
                      ...
                      <span style={{ fontSize: "0.7rem", color: TH.textSec }}>2 min ago</span>
                    </div>
                    <div style={{ fontWeight: 600, fontSize: "0.85rem", marginBottom: "4px" }}>Example Subject</div>
                    <div style={{ fontSize: "0.8rem", color: TH.textSec, marginBottom: "8px" }}>Message preview text here...</div>
                    <div style={{ display: "flex", gap: "6px" }}>
                      <button style={Object.assign({}, btnBase, {
                        padding: "4px 10px", borderRadius: "6px",
                        border: "1px solid " + TH.primary, background: TH.primary + "14",
                        color: TH.primary, fontSize: "0.7rem", fontWeight: 600,
                      })}>{rtl ? "\u0631\u062f" : "Reply"}</button>
                      <button style={Object.assign({}, btnBase, {
                        padding: "4px 10px", borderRadius: "6px",
                        border: "1px solid #22C55E", background: "rgba(34,197,94,0.08)",
                        color: "#22C55E", fontSize: "0.7rem", fontWeight: 600,
                      })}>{rtl ? "\u0645\u0642\u0631\u0648\u0621" : "Mark Read"}</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div style={{
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ color: TH.textSec, fontSize: "0.78rem" }}>
                  {(openArticle.language || "") + " \u2022 " + (openArticle.mood || "") + " \u2022 " + (openArticle.word_count || "?") + " " + t("words")}
                </div>
              </div>
              <button
                onClick={function () { setOpenArticle(null); }}
            ...
            <div style={{
              ...
              <button
                onClick={function () {
                  ...
                  if (hasWatermark) {
                    content = "================================================\n   OXQUILL FREE VERSION — oxquill.com\n================================================\n\n" + content + "\n\n================================================\n  Upgrade to remove watermarks\n================================================";
                  }
                  var blob = new Blob([content], { type: "text/plain;charset=utf-8" });
                  var url = URL.createObjectURL(blob);
                  var a = document.createElement("a");
                ...
                style={Object.assign({}, btnBase, {
                  ...
                  color: "#F59E0B", padding: "8px 16px", borderRadius: "8px",
              ...
              <button
                ...
                style={Object.assign({}, btnBase, {
                  background: TH.primary + "18", border: "1px solid " + TH.primary,
                  color: TH.primary, padding: "8px 16px", borderRadius: "8px",
                  fontSize: "0.85rem", fontWeight: 600,
          ...
          <div style={{
            ...
            {[
              ...
              { ic: "\ud83d\udce7", key: "shareEmail", action: function () {
                var subj = encodeURIComponent("Check out this article from OxQuill");
              ...
              { ic: "\ud83c\udf10", key: "shareSocial", action: function () {
                var text = encodeURIComponent("Check out this article from OxQuill! " + window.location.href);
