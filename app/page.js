...
export default function Home() {
  ...
  function buildPrompt(toolParam) {
    ...
    if (currentTool === "roast") {
      ...
      /* FIX: use `language` (updated by Writer dropdown); roastLang kept for backward compat */
      var roastLangFinal = language || roastLang;
      return "You are a brutally honest but hilarious writing critic. " + lvNote +
        " Respond in " + roastLangFinal + ". Roast this article. Give it a score out of 10." +
    ...
    if (currentTool === "debate") {
      ...
      /* FIX: use `language` (updated by Writer dropdown); battleLang kept for backward compat */
      var debateLangFinal = language || battleLang;
      return "Create a detailed debate about: " + debateTopic + ". Language: " + debateLangFinal +
        ...
        {view === "roast" && (
          <div style={{ padding: "24px 16px 40px", maxWidth: "660px", margin: "0 auto", textAlign: "center" }}>
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              <select
                value={roastLang}
                onChange={function (e) { setRoastLang(e.target.value); setLanguage(e.target.value); }}
        ...
        {view === "battle" && (
          <div style={{ padding: "24px 16px 40px", maxWidth: "660px", margin: "0 auto", textAlign: "center" }}>
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              <select
                value={battleLang}
                onChange={function (e) { setBattleLang(e.target.value); setLanguage(e.target.value); }}
                style={Object.assign({}, inputStyle, { width: "auto", display: "inline-block", marginBottom: 0, padding: "10px 14px" })}
              >
                {LANGUAGES.map(function (l) { return <option key={l} value={l}>{flag(l) + l}</option>; })}
              </select>
