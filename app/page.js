...
export default function Home() {
  ...
  async function handleGenerate(toolOverride) {
    ...
    try {
      ...
      /* FIX: Anthropic returns content as an array of blocks, not a string.
         Extract the text before setting state to prevent React render crash. */
      var extractedText = "";
      ...
      if (extractedText && extractedText.trim()) {
        ...
        if (currentTool === "generate" && safeDb && user) {
          try {
