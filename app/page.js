...
```
  ...
  <div style={{position:"relative",zIndex:1,paddingTop:56}}>
    ...
    {view==="admin" && isAdmin && <AdminPage {...{t,rtl,allUsers,userSearch,setUserSearch,adminTab,setAdminTab,toggleBlock,handleMakeAdmin,newAdminEmail,setNewAdminEmail,articles}}/>}
  </div>
  ...
  <footer style={{borderTop:"1px solid var(--bd)",padding:"40px 20px 24px",marginTop:40}}>
    <div style={{maxWidth:1100,margin:"0 auto"}}>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(160px,1fr))",gap:24,marginBottom:28}}>
        ...
        <div>
          <div style={{fontSize:10,fontWeight:800,letterSpacing:1,textTransform:"uppercase",color:"var(--t3)",marginBottom:10}}>Company</div>
        ...
        <div>
          <div style={{fontSize:10,fontWeight:800,letterSpacing:1,textTransform:"uppercase",color:"var(--t3)",marginBottom:10}}>Legal</div>
...
{p.rtl ? <>اكتب <em style={{color:”#EF7B6C”,fontStyle:“italic”}}>محتوى رائع</em><br/><span style={{color:“var(–pr)”}}>بقوة الذكاء الاصطناعي</span></> : <>Write <em style={{color:”#EF7B6C”,fontStyle:“italic”}}>Brilliant</em> Content<br/><span style={{color:“var(–pr)”}}>with AI Superpowers</span></>}
</h1>
<p style={{fontSize:“clamp(13px,2vw,16px)”,color:“var(–t2)”,maxWidth:580,margin:“0 auto 26px”,lineHeight:1.7}}>
{p.rtl?“ولّد، حلّل، نافس، وأعد استخدام مقالاتك. كل ما تحتاجه لصنع محتوى يتصدر.”:“Generate, analyze, battle, and repurpose your articles. Everything you need to create content that ranks, converts, and resonates.”}
</p>
...
// ═══════════════════════════════════════════════════════════════════
// PAYMENT MODAL (Simulation — replace with LemonSqueezy in Phase 2)
// ═══════════════════════════════════════════════════════════════════
function PayModal(p){
