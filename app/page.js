          ...
          <div style={{ padding: "24px 16px 40px", maxWidth: "750px", margin: "0 auto" }}>
            ...
            {result && (
              <div style={Object.assign({}, cardStyle, { marginTop: "24px", position: "relative" })}>
                {/* #8 Watermark — FIX: visible on both light and dark mode */}
                {hasWatermark && (
                  <div style={{
                    position: "absolute", top: "50%", left: "50%",
                    transform: "translate(-50%,-50%) rotate(-30deg)",
                    fontSize: "2.8rem", fontWeight: 900,
                    color: darkMode ? "rgba(155,123,240,0.22)" : "rgba(91,108,240,0.16)",
                    pointerEvents: "none",
                    whiteSpace: "nowrap", zIndex: 1,
                    letterSpacing: "3px",
                    textShadow: darkMode ? "0 0 20px rgba(155,123,240,0.3)" : "none",
                  }}>{t("watermarkText")}</div>
                )}
