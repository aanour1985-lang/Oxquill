...
export default function Home() {
  ...
  function handleCopy() {
    if (!canCopy) {
      showToast(rtl ? "\u0631\u0642\u064a \u062e\u0637\u062a\u0643 \u0644\u0644\u0646\u0633\u062e" : "Upgrade to copy", "error");
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", gap: "8px" }}>
                    ...
                    <button
                      onClick={function () {
                        if (!canCopy) {
                          showToast(rtl ? "\u0631\u0642\u064a \u062e\u0637\u062a\u0643 \u0644\u0644\u062a\u062d\u0645\u064a\u0644" : "Upgrade to download", "error");
                          setTimeout(function () { navigate("pricing"); }, 900);
                          return;
                        }
                        var content = result;
            ...
            <div style={{
              ...
              <button
                onClick={function () {
                  if (!canCopy) {
                    showToast(rtl ? "\u0631\u0642\u064a \u062e\u0637\u062a\u0643 \u0644\u0644\u062a\u062d\u0645\u064a\u0644" : "Upgrade to download", "error");
                    setTimeout(function () { setOpenArticle(null); navigate("pricing"); }, 900);
                    return;
                  }
