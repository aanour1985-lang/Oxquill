...
var I18N = {
  ...
  "hero.title": { en: "Every Writer Deserves a ", ar: "\u0643\u0644 \u0643\u0627\u062a\u0628 \u064a\u0633\u062a\u0627\u0647\u0644 " },
  "hero.word": { en: "Superbrain", ar: "\u0639\u0642\u0644 \u062e\u0627\u0631\u0642" },
  "hero.end": { en: ". Now You Have One.", ar: ". \u062f\u0647 \u0639\u0642\u0644\u0643." },
      ...
      <section style={{paddingTop:40,paddingBottom:40,textAlign:"center"}}>
        <div style={{maxWidth:900,margin:"0 auto",padding:"0 20px"}}>
          ...
          <h1 style={{fontFamily:"Source Serif 4,Georgia,serif",fontSize:"clamp(32px,7vw,60px)",fontWeight:900,lineHeight:1.05,marginBottom:16,letterSpacing:-1}}>
            {p.t("hero.title")}<span style={{background:"linear-gradient(135deg,#5B6CF0,#9B7BF0)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>{p.t("hero.word")}</span>{p.t("hero.end")}
          </h1>
